...
if (typeof jQuery != 'undefined') {
    ...
    jQuery(function($) {
        ...
        ARK.squeezeBox = {
            ...
            build: function() {
                ...
                if (this.options.shadow) {
                    ...
                    $.each(['n', 'ne', 'e', 'se', 's', 'sw', 'w', 'nw'], function(i, dir) {
                        ...
                        }).appendTo(shadow).click(relay);
                    });
                }

                this.content = $('<div></div>').attr({
                    id: 'sbox-content'
                }).appendTo(this.win);
                this.closeBtn = $('<a></a>').attr({
                    id: 'sbox-btn-close',
                    href: '#',
                    role: 'button'
                }).appendTo(this.win);
            ...
            reposition: function() {
                var size = getSize(this.doc),
                    scroll = getScroll(this.doc),
                    ssize = getScrollSize(this.doc);
        ...
        function getScroll(element) {
            var win = $(element).is('window') ? element : (element.parentWindow || element.defaultView),
                doc = getCompatElement(element);
            return {
