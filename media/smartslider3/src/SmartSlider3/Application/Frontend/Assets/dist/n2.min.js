! function(t) {
    ...
    x((function() {
        ...
        function() {
            ...
            function a() {
                ...
                !i.n2Slow && n.length && (i.n2Slow = !0), n.unshift.apply(n, s), (s = n).length ? _(a, {
                    timeout: 2e3
                }) : o = !1
            }

            function c(t) {
                s.unshift(t), o || (o = !0, _(a, {
                    timeout: 2e3
                }))
            }
            var l = new Date,
                v = function() {
                    if (i.jQuery) {
                        ...
                        if (u(v, 20), (new Date).getTime() - l.getTime() > 1e3) f("script").src = h._jQueryFallback
                    }
                };
            ...
            function p(i, r, s) {
                var o = [];
                if (d(i) || n[i]) {
                    if ("function" == typeof r ? (s = r, r = []) : "string" == typeof r && (r = [r]), (r = r || []).length)
                        for (var u = 0; u < r.length; u++) d(r[u]), o.push(t[r[u]]);
            ...
            function g(i, n) {
                var s = [];
                if (n === r ? (n = i, i = []) : "string" == typeof i && (i = [i]), i = i || [])
            ...
            return function() {
                var s = this,
                    ...
                    f = n && !r;
                a(r), r = u(h, i), f && t.apply(s, o)
            }
        }, h.r("nextend-frontend", (function() {
            if (x((function() {
                    h.d("documentReady")
                })), "complete" === s.readyState) h.d("windowLoad");
            else {
                let r;
            ...
            function M(t) {
                ...
                var r = p(t).getComputedStyle(t),
                    ...
                    a = m(r.width),
                    h = m(r.height);
                if ("border-box" === r.boxSizing && (Math.round(a + o) !== i && (a -= w(r, "left", "right") + o), Math.round(h + u) !== n && (h -= w(r, "top", "bottom") + u)), !_(t)) {
                    var f = Math.round(a + o) - i,
                        c = Math.round(h + u) - n;
                    1 !== Math.abs(f) && (a -= f), 1 !== Math.abs(c) && (h -= c)
                }
                return P(s.left, s.top, a, h)
            }
        ...
        function() {
            ...
            class u {
                constructor(i, n) {
                    t(i) ? this.k = Array.from(i) : this.k = [i], this.P = c({}, n), this.S = new Set
                }
                get scale() {
                    return this.scaleX
                }
                    ...
                    for (let i of this.S) {
                        ...
                        switch (i) {
                            ...
                            case "filter":
                                ...
                                break;
                            case "n2AutoAlpha":
                                0 === this.opacity ? this.A || (this.A = !0, this.I("data-force-hidden", "")) : this.A && (this.A = !1, this.R("data-force-hidden"));
                                continue;
                            case "opacity":
                                this.P.n2AutoAlpha && (0 === t ? this.A || (this.A = !0, this.I("data-force-hidden", "")) : this.A && (this.A = !1, this.R("data-force-hidden")));
                                break;
                            case "width":
                            case "height":
                            case "perspective":
                ...
                F() {
                    ...
                    return k && (S += "perspective(" + k + "px) "), (t || i) && (S += "translate(" + (t || 0) + "%, " + (i || 0) + "%) "), (a || h) && (S += "translate(" + (a || 0) + "px, " + (h || 0) + "px) "), (f || c) && (S += "translate(" + (f || 0) + "%, " + (c || 0) + "%) "), S += n(s, o, u, P), _ && (S += "skewX(" + _ + "deg) "), O && (S += "skewY(" + O + "deg) "), g && (S += "rotate(" + g + "deg) "), m && (S += "rotate(" + m + "deg) "), w && (S += "rotateY(" + w + "deg) "), y && (S += "rotateX(" + y + "deg) "), b === r && (b = 1), M === r && (M = 1), 1 === b && 1 === M || (S += "scale(" + b + ", " + M + ") "), x === r && (x = 1), 1 !== x && (S += "scaleZ(" + x + ") "), S || "translate3d(0, 0, 0)"
                }
                C() {
                    let {
                        n2blur: t
            ...
            var f = {},
                ...
                v = function(t, i, n) {
                    Object.getOwnPropertyDescriptor(u.prototype, t) || (i === r && (i = ""), n === r && (n = t), f[n] === r && (f[n] = []), f[n].push(t), o[t] = i, Object.defineProperty(u.prototype, t, {
                        get: function() {
                            return this.P[t] === r && (this.P[t] = o[t]), this.P[t]
                        },
                        set: function(i) {
                            i instanceof Function && (i = i()), this.P[t] !== i && (this.P[t] = i, this.S.add(n), s.add(this))
                        }
                    }), l(t))
                },
                d = function(t, i) {
            ...
            var w = h.MW = {
                B: v,
                i: function(t, i) {
                    return t.smw || (t.smw = new u(t, i)), t.smw
                },
                L: function(t, i) {
            ...
            connectedCallback() {
                if (this.isConnected) {
                    n = n || s.body, this.h = "rtl" === o.getAttribute("dir"), this._width = 0, this._offset = Number.MAX_SAFE_INTEGER, this.Z = h.MW.i(this, {
                    ...
                    var r = n;
                    if (i.ssForceFullHorizontalSelector) r = i.ssForceFullHorizontalSelector;
                    else {
                        var u = d(this, "horizontalSelector");
                        if (u && "body" !== u) try {
                            r = this.closest(u)
                        } catch (t) {}
                    }
                    if (r === n)
                        for (var a = [".elementor-section-stretched", '.siteorigin-panels-stretch[data-stretch-type="full-stretched"]', '.siteorigin-panels-stretch[data-stretch-type="full-stretched-padded"]', ".themify_builder_row.fullwidth", '.vce-row[data-vce-stretch-content="true"]'], f = 0; f < a.length; f++) {
                            var c = this.closest(a[f]);
                            if (c) {
                                r = c;
                                break
                            }
            ...
            doResize() {
                ...
                if (this.fullWidthTo) {
                    ...
                    r = s.width, t = this.h ? -r + s.right : s.left
                }
                var o, u, a = r > 0 ? r : n.clientWidth,
                    h = i.getComputedStyle(this.parentNode);
                o = this.h ? a - this.parentNode.getBoundingClientRect().right - parseInt(h.getPropertyValue("padding-right")) - parseInt(h.getPropertyValue("border-right-width")) + t : -this.parentNode.getBoundingClientRect().left - parseInt(h.getPropertyValue("padding-left")) - parseInt(h.getPropertyValue("border-left-width")) + t, o += u = o % 1, a -= Math.floor(u), (this._width - a <= 0 || this._width - a > 1 || this._offset - o < -1 || this._offset - o >= 0) && (this._offset !== o && (this.Z.x = o, this._offset = o, 0 !== o && this.classList.add("n2-ss-no-bga-fixed")), this._width !== a && (this.Z.width = a, this._width = a)), this.setVisible && this.setVisible()
            }
            setVisible() {
            ...
            syncStyle() {
                this.V.length ? this.G || (this.G = u(this.show.bind(this), 100)) : (this.G && (a(this.G), delete this.G), this.display = "")
            }
        });
    ...
    i.n2const = {
        ...
        h._shouldPreventClick || (h._shouldPreventClick = !0, u((function() {
        ...
        function v(i, r, s) {
            ...
            var a = this.context = new l(i, r, s.leaveOnSecond);
        ...
        s.prototype.addTimeout = function(t) {
            ...
            delete this.currentTarget, this.addTimeout(u(function() {
                this.preventMouse = !1
            }.bind(this), 1e3))
            ...
            for (var t = 0; t < this.localListeners.length; t++) this.localListeners[t][0].removeEventListener(this.localListeners[t][1], this.localListeners[t][2], this.localListeners[t][3]);
            var i;
            this.isActive = !1, i = this.el, y(i, new Event("universalleave", {
                bubbles: !1,
                cancelable: !1
            }))
        ...
        return function(a, h) {
            ...
            function C(e, t) {
                if ((e.isPrimary === r || e.isPrimary) && !o && (l = [], x = !0, !k[p = t](e) && !P(e.target)))
            ...
            function A(t) {
                (t.isPrimary === r || t.isPrimary) && ("x" === f.axis && (!f.preventScroll && v || k[p](t)) || P(t.target) || (F(t), (Math.abs(w.x) > 10 || Math.abs(w.y) > 10) && (x = !1), v === r && 2 !== p && (v = Math.abs(w.x) < Math.abs(w.y) && !f.preventScroll) || f.move(t, m, w, d) && f.preventDefault && S(t)))
            }
            ...
            function E(t) {
                if (t.isPrimary === r || t.isPrimary) {
                    p && F(t), !x && t.target && t.target.blur && t.target.blur();
            ...
            }))), 1 === _ && (a.style.touchAction = "y" === f.axis ? "pan-x" : "pan-y"), y.push(M(a, O[_][0], (function(e) {
                C(e, _)
            }), {
                passive: !1,
                capture: !0
            })), 0 === _ && y.push(M(a, O[0][1], (function(e) {
                A(e)
            }), {
                passive: !1,
                capture: !0
            })), y.push(M(a, "dragstart", S)), f.mouse && 0 === _ && y.push(M(a, O[2][0], (function(e) {
                C(e, 2)
            }))), y.push(M(a, "click", (function(t) {
                x ? f.click(t) : S(t)
            }))), {
                supportsPointerEvents: g.pointerEvents,
        ...
        ! function(e) {
            ...
            function O(e, t, i) {
                var n, r = o(e[1]),
                    s = (r ? 2 : 1) + (t < 2 ? 0 : 1),
                    u = e[s];
                if (r && (u.duration = e[1]), u.parent = i, t) {
                    for (n = u; i && !("immediateRender" in n);) n = i.vars.defaults || {}, i = c(i.vars.inherit) && i.parent;
                    u.immediateRender = c(n.immediateRender), t < 2 ? u.runBackwards = 1 : u.startAt = e[s - 1]
                }
                return u
            }
            ...
            function j(t, e) {
                var i;
                if ((e._time || e._initted && !e._dur) && (i = L(t.rawTime(), e), (!e._dur || bi(0, e.totalDuration(), i) - e._tTime > Zt) && e.render(i, !0)), D(t, e)._dp && t._initted && t._time >= t._dur && t._ts) {
            ...
            function N(t, e, i, n) {
                return e.parent && z(e), e._start = x(i + e._delay), e._end = x(e._start + (e.totalDuration() / Math.abs(e.timeScale()) || 0)),
                    function(t, e, i, n, r) {
                        void 0 === i && (i = "_first"), void 0 === n && (n = "_last");
                        var s, o = t[n];
                        if (r)
            ...
            function Q(t, e) {
                return (ai.ScrollTrigger || p("scrollTrigger", e)) && ai.ScrollTrigger.create(e, t)
            }

            function U(t, e, i, n) {
                return Zi(t, e), t._initted ? !i && t._pt && (t._dur && !1 !== t.vars.lazy || !t._dur && t.vars.lazy) && Ot !== Ci.frame ? (fi.push(t), t._lazy = [e, n], 1) : void 0 : 1
            }
            ...
            function V(t, e) {
                ...
                return r(e) && (isNaN(e) || e in s) ? "<" === (i = e.charAt(0)) || ">" === i ? ("<" === i ? o._start : o.endTime(0 <= o._repeat)) + (parseFloat(e.substr(1)) || 0) : (i = e.indexOf("=")) < 0 ? (e in s || (s[e] = u), s[e]) : (n = +(e.charAt(i - 1) + e.substr(i + 1)), 1 < i ? V(t, e.substr(0, i - 1)) + n : u + n) : null == e ? u : +e
            }
            ...
            function K(t) {
                ...
                return r(o) ? l = v = {
                    ...
                    function(t, e, r) {
                        var s, f, d, p, g, m, w, y, b, M = (r || i).length,
                            _ = a[M];
                        if (!_) {
                            ...
                            for (_ = a[M] = [], s = h ? Math.min(b, M) * l - .5 : o % b, f = h ? M * v / b - .5 : o / b | 0, y = Wt, m = w = 0; m < M; m++) d = m % b - s, p = f - (m / b | 0), _[m] = g = c ? Math.abs("y" === c ? p : d) : Ht(d * d + p * p), w < g && (w = g), g < y && (y = g);
                            "random" === o && J(_), _.max = w - y, _.min = y, _.v = M = (parseFloat(i.amount) || parseFloat(i.each) * (M < b ? M - 1 : c ? "y" === c ? M / b : b : Math.max(b, M / b)) || 0) * ("edges" === o ? -1 : 1), _.b = M < 0 ? u - M : u, _.u = G(i.amount || i.each) || 0, n = n && M < 0 ? Ti(n) : n
                        }
            ...
            function it(t, i) {
                ...
                return !e && f(t) && (n = e = t.radius || Wt, t.values ? (t = xi(t.values), (r = !o(t[0])) && (n *= n)) : t = tt(t.increment)), q(i, e ? s(t) ? function(i) {
                    ...
                    for (var e, s, u = parseFloat(r ? i.x : i), a = parseFloat(r ? i.y : 0), h = Wt, f = 0, c = t.length; c--;)(e = r ? (e = t[c].x - u) * e + (s = t[c].y - a) * s : Math.abs(t[c] - u)) < h && (h = e, f = c);
            ...
            function st(t, e, i) {
                var n, r, s, o = t.labels,
                    u = Wt;
                for (n in o)(r = o[n] - e) < 0 == !!i && r && u > (r = Math.abs(r)) && (s = n, u = r);
                return s
            }
            ...
            function at(t, e, i) {
                var n, r, s, u, a, h, f, c, l, v, d = t ? o(t) ? [t >> 16, t >> 8 & ki, t & ki] : 0 : Pi.black;
                if (!d) {
                    if ("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), Pi[t]) d = Pi[t];
                    else if ("#" === t.charAt(0)) {
                        ...
                        } else u = +d[0] % 360 / 360, a = d[1] / 100, n = 2 * (h = d[2] / 100) - (r = h <= .5 ? h * (a + 1) : h + a - h * a), 3 < d.length && (d[3] *= 1), d[0] = ut(u + 1 / 3, n, r), d[1] = ut(u, n, r), d[2] = ut(u - 1 / 3, n, r);
                    else d = t.match(ii) || Pi.transparent;
                    d = d.map(Number)
                }
                return e && !v && (n = d[0] / ki, r = d[1] / ki, s = d[2] / ki, h = ((f = Math.max(n, r, s)) + (c = Math.min(n, r, s))) / 2, f === c ? u = a = 0 : (l = f - c, a = .5 < h ? l / (2 - f - c) : l / (f + c), u = f === n ? (r - s) / l + (r < s ? 6 : 0) : f === r ? (s - n) / l + 2 : (n - r) / l + 4, u *= 60), d[0] = ~~(u + .5), d[1] = ~~(100 * a + .5), d[2] = ~~(100 * h + .5)), i && d.length < 4 && (d[3] = 1), d
            }
            ...
            function ft(t, e, i) {
                ...
                if (a = a.map((function(t) {
                    ...
                    })), i && (s = ht(t), (n = i.c).join(u) !== s.c.join(u)))
                    for (o = (r = t.replace(Si, "1").split(ri)).length - 1; f < o; f++) u += r[f] + (~n.indexOf(f) ? a.shift() || h + "0,0,0,0)" : (s.length ? s : a.length ? a : i).shift());
                if (!r)
                    for (o = (r = t.split(Si)).length - 1; f < o; f++) u += r[f] + a[f];
                return u + r[o]
            }

            function ct(t) {
                var e, i = t.join(" ");
                if (Si.lastIndex = 0, Si.test(i)) return e = Fi.test(i), t[1] = ft(t[1], e), t[0] = ft(t[0], e, ht(t[1])), !0
            }
            ...
            function vt(t, e, i, n) {
                ...
                return M(t, (function(t) {
                    for (var e in Ii[t] = ai[t] = s, Ii[r = t.toLowerCase()] = i, s) Ii[r + ("easeIn" === e ? ".in" : "easeOut" === e ? ".out" : ".inOut")] = Ii[t + "." + e] = s[e]
                })), s
            }
            ...
            function pt(t, i, e) {
                ...
                var r = 1 <= i ? i : 1,
                    ...
                    u = "out" === t ? n : "in" === t ? function(t) {
                        return 1 - n(1 - t)
                    } : dt(n);
                return s = Vt / s, u.config = function(i, e) {
                    return pt(t, i, e)
                }, u
            }
            ...
            var mt, wt, yt, bt, Mt, xt, _t, Ot, kt, Pt, St, Ft, Ct, At, It, Et, Rt, Tt, zt, Dt, Bt, Lt, Xt, Yt, jt, Nt, Qt = {
                    autoSleep: 120,
                    force3D: "auto",
                    nullTargetWarn: 1,
                    units: {
                ...
                Fi = /hsl[a]?\(/,
                Ci = (Rt = Date.now, Tt = 500, zt = 33, Dt = Rt(), Bt = Dt, Xt = Lt = 1e3 / 240, At = {
                    time: 0,
                    frame: 0,
                    tick: function() {
                        Di(!0)
                    ...
                    wake: function() {
                        _t && (!bt && l() && (yt = bt = i, Mt = yt.document || {}, ai.gsap = gn, (yt.gsapVersions || (yt.gsapVersions = [])).push(gn.version), d(xt || yt.GreenSockGlobals || !yt.gsap && yt || {}), Ct = yt.requestAnimationFrame), St && At.sleep(), Ft = Ct || function(t) {
                            return u(t, Xt - 1e3 * At.time + 1 | 0)
                        }, Pt = 1, Di(2))
                    },
                    sleep: function() {
                        (Ct ? yt.cancelAnimationFrame : a)(St), Pt = 0, Ft = w
                    },
                    ...
                    remove: function(t) {
                        var e;
                        ~(e = Yt.indexOf(t)) && Yt.splice(e, 1) && e <= Et && Et--
                    },
                    _listeners: Yt = []
                }),
                Ai = function() {
                ...
                zi = function(t, e) {
                    return t && (s(t) ? t : Ii[t] || function(t) {
                        ...
                        return i && 1 < e.length && i.config ? i.config.apply(null, ~t.indexOf("{") ? [function(t) {
                            for (var e, i, n, r = {}, s = t.substr(1, t.length - 3).split(":"), o = s[0], u = 1, a = s.length; u < a; u++) i = s[u], e = u !== a - 1 ? i.lastIndexOf(",") : i.length, n = i.substr(0, e), r[o] = isNaN(n) ? n.replace(Ri, "").trim() : +n, o = i.substr(e + 1).trim();
                            return r
                        }(e[1])] : function(t) {
                            var e = t.indexOf("(") + 1,
                                i = t.indexOf(")"),
                        ...
                        }(t).split(",").map(S)) : Ii._CE && Ei.test(t) ? Ii._CE("", t) : i
                    }(t)) || e
                };
            ...
            function Di(t) {
                var e, i, n, r, s = Rt() - Bt,
                    o = !0 === t;
                if (Tt < s && (Dt += s - zt), (0 < (e = (n = (Bt += s) - Dt) - Xt) || o) && (r = ++At.frame, It = n - 1e3 * At.time, At.time = n /= 1e3, Xt += e + (Lt <= e ? 4 : Lt - e), i = 1), o || (St = Ft(Di)), i)
                    for (Et = 0; Et < Yt.length; Et++) Yt[Et](n, It, r, t)
            }
            ...
            M("Linear,Quad,Cubic,Quart,Quint,Strong", (function(t, e) {
                ...
                return 1 - Bi(1 - t)
            }), Bi), vt("Expo", (function(t) {
                return t ? Math.pow(2, 10 * (t - 1)) : 0
            })), vt("Circ", (function(t) {
                return -(Ht(1 - t * t) - 1)
            })), vt("Sine", (function(t) {
                return 1 === t ? 1 : 1 - $t(t * qt)
            })), vt("Back", gt("in"), gt("out"), gt()), Ii.SteppedEase = Ii.steps = ai.SteppedEase = {
                config: function(t, e) {
                    void 0 === t && (t = 1);
                    var i = 1 / t,
                        n = t + (e ? 0 : 1),
            ...
            var Li, Xi = function(t, e) {
                ...
                Yi = ((Li = ji.prototype).delay = function(t) {
                    ...
                    return arguments.length ? this.totalTime(Math.min(this.totalDuration(), t + B(this)) % this._dur || (t ? this._dur : 0), e) : this._time
                    ...
                    return this._rts = +t || 0, this._ts = this._ps || t === -Zt ? 0 : this._rts,
                        function(t) {
            ...
            function ji(t, e) {
                var i = t.parent || wt;
                this.vars = t, this._delay = +t.delay || 0, (this._repeat = t.repeat === 1 / 0 ? -2 : t.repeat || 0) && (this._rDelay = t.repeatDelay || 0, this._yoyo = !!t.yoyo || !!t.yoyoEase), this._ts = 1, W(this, +t.duration, 1, 1), this.data = t.data, Pt || Ci.wake(), i && N(i, this, e || 0 === e ? e : i._time, 1), t.reversed && this.reverse(), t.paused && this.paused(!0)
            }
            C(Yi.prototype, {
                _time: 0,
                _start: 0,
            ...
            var Ni = function(i) {
                ...
                return e.to = function(t, e, i, n) {
                    ...
                    return e.duration = 0, e.parent = this, R(e).repeatDelay || (e.repeat = 0), e.immediateRender = !!e.immediateRender, new Hi(t, e, V(this, i), 1), this
                    ...
                    return i.runBackwards = 1, R(i).immediateRender = c(i.immediateRender), this.staggerTo(e, t, i, n, r, s, o)
                }, e.staggerFromTo = function(e, t, i, n, r, s, o, u) {
                    return n.startAt = i, R(n).immediateRender = c(n.immediateRender), this.staggerTo(e, t, n, r, s, o, u)
                }, e.render = function(t, e, i) {
                    var n, r, s, o, u, a, h, f, c, l, v, d, p = this._time,
                        g = this._dirty ? this.totalDuration() : this._tDur,
                        m = this._dur,
                        w = this !== wt && g - Zt < t && 0 <= t ? g : t < Zt ? 0 : t,
                        y = this._zTime < 0 != t < 0 && (this._initted || !m);
                    if (w !== this._tTime || i || y) {
                        if (p !== this._time && m && (w += this._time - p, t += this._time - p), n = w, c = this._start, a = !(f = this._ts), y && (m || (p = this._zTime), !t && e || (this._zTime = t)), this._repeat) {
                            if (v = this._yoyo, u = m + this._rDelay, this._repeat < -1 && t < 0) return this.totalTime(100 * u + t, e, i);
                            if (n = x(w % u), w === g ? (o = this._repeat, n = m) : ((o = ~~(w / u)) && o === w / u && (n = m, o--), m < n && (n = m)), l = wi(this._tTime, u), !p && this._tTime && l !== o && (l = o), v && 1 & o && (n = m - n, d = 1), o !== l && !this._lock) {
                                var b = v && 1 & l,
                                    M = b === (v && 1 & o);
                                if (o < l && (b = !b), p = b ? 0 : m, this._lock = 1, this.render(p || (d ? 0 : x(o * u)), e, !m)._lock = 0, !e && this.parent && Oi(this, "onRepeat"), this.vars.repeatRefresh && !d && (this.invalidate()._lock = 1), p && p !== this._time || a != !this._ts || this.vars.onRepeat && !this.parent && !this._act) return this;
                                if (m = this._dur, g = this._tDur, M && (this._lock = 2, p = b ? m : -1e-4, this.render(p, !0)), this._lock = 0, !this._ts && !a) return this;
                                lt(this, d)
                            }
                        }
                        if (this._hasPause && !this._forcing && this._lock < 2 && (h = function(t, e, i) {
                            ...
                            }(this, x(p), x(n))) && (w -= n - (n = h._start)), this._tTime = w, this._time = n, this._act = !f, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = t, p = 0), p || !n || e || Oi(this, "onStart"), p <= n && 0 <= t)
                            for (r = this._first; r;) {
                                if (s = r._next, (r._act || n >= r._start) && r._ts && h !== r) {
                                    if (r.parent !== this) return this.render(t, e, i);
                                    if (r.render(0 < r._ts ? (n - r._start) * r._ts : (r._dirty ? r.totalDuration() : r._tDur) + (n - r._start) * r._ts, e, i), n !== this._time || !this._ts && !a) {
                                ...
                                for (var _ = t < 0 ? t : n; r;) {
                                    if (s = r._prev, (r._act || _ <= r._end) && r._ts && h !== r) {
                                        if (r.parent !== this) return this.render(t, e, i);
                                        if (r.render(0 < r._ts ? (_ - r._start) * r._ts : (r._dirty ? r.totalDuration() : r._tDur) + (_ - r._start) * r._ts, e, i), n !== this._time || !this._ts && !a) {
                    ...
                    return arguments.length ? (this._forcing = 1, !this._dp && this._ts && (this._start = x(Ci.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts))), i.prototype.totalTime.call(this, t, e), this._forcing = 0, this) : this._tTime
                    ...
                    for (var i, n = [], r = xi(t), s = this._first, u = o(e); s;) s instanceof Hi ? _(s._targets, r) && (u ? (!Ui || s._initted && s._ts) && s.globalTime(0) <= e && s.globalTime(s.totalDuration()) > e : !e || s.isActive()) && n.push(s) : (i = s.getTweensOf(r, e)).length && n.push.apply(n, i), s = s._next;
                    return n
                    ...
                    if (s._dirty) {
                        for (n = s.parent; o;) e = o._prev, o._dirty && o.totalDuration(), u < (i = o._start) && s._sort && o._ts && !s._lock ? (s._lock = 1, N(s, o, i - o._delay, 1)._lock = 0) : u = i, i < 0 && o._ts && (r -= i, (!n && !s._dp || n && n.smoothChildTiming) && (s._start += i / s._ts, s._time -= i, s._tTime -= i), s.shiftChildren(-i, !1, -1 / 0), u = 0), o._end > r && o._ts && (r = o._end), o = e;
                        W(s, s === wt && s._time > r ? s._time : r, 1, 1), s._dirty = 0
                    }
                    return s._tDur
                }, u.updateRoot = function(t) {
                    if (wt._ts && (P(wt, L(t, wt)), Ot = Ci.frame), Ci.frame >= di) {
                        di += Qt.autoSleep || 120;
                        var e = wt._first;
                        if ((!e || !e._ts) && Qt.autoSleep && Ci._listeners.length < 2) {
            ...
            function Qi(t, e, i, n, o, u) {
                var a, h, c, l;
                if (li[t] && !1 !== (a = new li[t]).init(o, a.rawVars ? e[t] : function(t, e, i, n, o) {
                        if (s(t) && (t = Vi(t, o, e, i, n)), !f(t) || t.style && t.nodeType || ti(t) || Kt(t)) return r(t) ? Vi(t, o, e, i, n) : t;
                        var u, a = {};
                        for (u in t) a[u] = Vi(t[u], o, e, i, n);
                        return a
                    }(e[t], n, o, u, i), i, n, u) && (i._pt = h = new cn(i._pt, o, t, 0, 1, a.render, a, 0, a.priority), i !== kt))
                    for (c = i._ptLookup[i._targets.indexOf(o)], l = a._props.length; l--;) c[a._props[l]] = h;
                return a
            }
            C(Ni.prototype, {
                _lock: 0,
            ...
            var Ui, Wi = function(t, e, i, n, o, u, a, h, f) {
                    s(n) && (n = n(o || 0, t, u));
                    var c, l = t[e],
                    ...
                    if (r(n) && (~n.indexOf("random(") && (n = et(n)), "=" === n.charAt(1) && (n = parseFloat(v) + parseFloat(n.substr(2)) * ("-" === n.charAt(0) ? -1 : 1) + (G(v) || 0))), v !== n) return isNaN(v * n) ? (l || e in t || p(e, n), function(t, e, i, n, r, s, o) {
                        var u, a, h, f, c, l, v, d, p = new cn(this._pt, t, e, 0, 1, on, null, r),
                            g = 0,
                            m = 0;
                        for (p.b = i, p.e = n, i += "", (v = ~(n += "").indexOf("random(")) && (n = et(n)), s && (s(d = [i, n], t, e), i = d[0], n = d[1]), a = i.match(ei) || []; u = ei.exec(n);) f = u[0], c = n.substring(g, u.index), h ? h = (h + 1) % 5 : "rgba(" === c.substr(-5) && (h = 1), f !== a[m++] && (l = parseFloat(a[m - 1]) || 0, p._pt = {
                            _next: p._pt,
                            p: c || 1 === m ? c : ",",
                            s: l,
                    ...
                    }.call(this, t, e, v, n, d, h || Qt.stringFilter, f)) : (c = new cn(this._pt, t, e, +v || 0, n - (v || 0), "boolean" == typeof l ? sn : en, 0, d), f && (c.fp = f), a && c.modifier(a, this, t), this._pt = c)
                },
                Zi = function t(e, i) {
                    var n, r, s, o, u, a, h, f, l, v, d, p, g, m = e.vars,
                        w = m.ease,
                        b = m.startAt,
                        M = m.immediateRender,
                        x = m.lazy,
                        ...
                        Y = e.timeline;
                    if (!Y || A && w || (w = "none"), e._ease = zi(w, Ut.ease), e._yEase = F ? Ti(zi(!0 === F ? w : F, Ut.ease)) : 0, F && e._yoyo && !e._repeat && (F = e._yEase, e._yEase = e._ease, e._ease = F), !Y) {
                        if (p = (f = D[0] ? y(D[0]).harness : 0) && m[f.prop], n = E(m, hi), T && T.render(-1, !0).kill(), b)
                            if (z(e._startAt = Hi.set(D, C({
                                    data: "isStart",
                                    overwrite: !1,
                                    parent: B,
                                    immediateRender: !0,
                                ...
                                else if (R && !(i < 0 && T)) return void(i && (e._zTime = i))
                        ...
                        for (e._pt = 0, x = R && c(x) || x && !R, r = 0; r < D.length; r++) {
                            if (h = (u = D[r])._gsap || $(D)[r]._gsap, e._ptLookup[r] = v = {}, ci[h.id] && fi.length && k(), d = L === D ? r : L.indexOf(u), f && !1 !== (l = new f).init(u, p || n, e, d, L) && (e._pt = o = new cn(e._pt, u, l.name, 0, 1, l.render, l, 0, l.priority), l._props.forEach((function(t) {
                                    v[t] = o
                                })), l.priority && (a = 1)), !f || p)
                                for (s in n) li[s] && (l = Qi(s, n, e, d, u, L)) ? l.priority && (a = 1) : v[s] = o = Wi.call(e, u, s, "get", n[s], d, L, 0, m.stringFilter);
                            e._op && e._op[r] && e.kill(u, e._op[r]), X && e._pt && (Ui = e, wt.killTweensOf(u, v, e.globalTime(0)), g = !e.parent, Ui = 0), e._pt && x && (ci[h.id] = 1)
                        }
                        a && fn(e), e._onInit && e._onInit(e)
                    }
                ...
                Hi = function(i) {
                    function s(e, t, r, s) {
                        ...
                        var a, h, l, d, p, m, y, b, M = (u = i.call(this, s ? t : R(t), r) || this).vars,
                            _ = M.duration,
                            O = M.delay,
                            k = M.immediateRender,
                            P = M.stagger,
                        ...
                        if (u._targets = z.length ? $(z) : g("GSAP target " + e + " not found. https://greensock.com", !Qt.nullTargetWarn) || [], u._ptLookup = [], u._overwrite = S, F || P || v(_) || v(O)) {
                            if (t = u.vars, (a = u.timeline = new Ni({
                                    data: "nested",
                                    defaults: A || {}
                                })).kill(), a.parent = a._dp = n(u), a._start = 0, F) C(a.vars.defaults, {
                                ease: "none"
                                ...
                                for (h = 0; h < d; h++) {
                                    ...
                                    l.stagger = 0, E && (l.yoyoEase = E), b && mi(l, b), m = z[h], l.duration = +Vi(_, n(u), h, m, z), l.delay = (+Vi(O, n(u), h, m, z) || 0) - u._delay, !P && 1 === d && l.delay && (u._delay = O = l.delay, u._start += O, l.delay = 0), a.to(m, l, y(h, m, z))
                                }
                                a.duration() ? _ = O = 0 : u.timeline = 0
                            }
                            _ || u.duration(_ = a.duration())
                        } else u.timeline = 0;
                        return !0 !== S || mt || (Ui = n(u), wt.killTweensOf(z), Ui = 0), T && j(T, n(u)), (k || !_ && !F && u._start === x(T._time) && c(k) && function t(i) {
                            return !i || i._ts && t(i.parent)
                        }(n(u)) && "nested" !== T.data) && (u._tTime = -Zt, u.render(Math.max(0, -O))), I && Q(n(u), I), u
                    }
                    t(s, i);
                    var e = s.prototype;
                    return e.render = function(t, e, i) {
                        var n, r, s, o, u, a, h, f, c, l = this._time,
                            v = this._tDur,
                            d = this._dur,
                        ...
                        if (d) {
                            if (p !== this._tTime || !t || i || !this._initted && this._tTime || this._startAt && this._zTime < 0 != t < 0) {
                                if (n = p, f = this.timeline, this._repeat) {
                                    ...
                                    if (n = x(p % o), p === v ? (s = this._repeat, n = d) : ((s = ~~(p / o)) && s === p / o && (n = d, s--), d < n && (n = d)), (a = this._yoyo && 1 & s) && (c = this._yEase, n = d - n), u = wi(this._tTime, o), n === l && !i && this._initted) return this;
                                    s !== u && (f && this._yEase && lt(f, a), !this.vars.repeatRefresh || a || this._lock || (this._lock = i = 1, this.render(x(o * s), !0).invalidate()._lock = 0))
                                }
                                if (!this._initted) {
                                ...
                                f && f.render(t < 0 ? t : !n && a ? -Zt : f._dur * h, e, i) || this._startAt && (this._zTime = t), this._onUpdate && !e && (t < 0 && this._startAt && this._startAt.render(t, !0, i), Oi(this, "onUpdate")), this._repeat && s !== u && this.vars.onRepeat && !e && this.parent && Oi(this, "onRepeat"), p !== this._tDur && p || this._tTime !== p || (t < 0 && this._startAt && !this._onUpdate && this._startAt.render(t, !0, !0), !t && d || !(p === this._tDur && 0 < this._ts || !p && this._ts < 0) || z(this, 1), e || t < 0 && !l || !p && !l || (Oi(this, p === v ? "onComplete" : "onReverseComplete", !0), !this._prom || p < v && 0 < this.timeScale() || this._prom()))
                            }
                        } else ! function(t, e, i, n) {
                            var r, s, o, u = t.ratio,
                                a = e < 0 || !e && (!t._start && function t(i) {
                                    var e = i.parent;
                                    return e && e._ts && e._initted && !e._lock && (e.rawTime() < 0 || t(e))
                                }(t) || (t._ts < 0 || t._dp._ts < 0) && "isFromStart" !== t.data && "isStart" !== t.data) ? 0 : 1,
                                h = t._rDelay,
                                f = 0;
                            if (h && t._repeat && (f = bi(0, t._tDur, e), s = wi(f, h), o = wi(t._tTime, h), t._yoyo && 1 & s && (a = 1 - a), s !== o && (u = 1 - a, t.vars.repeatRefresh && t._initted && t.invalidate())), a !== u || n || t._zTime === Zt || !e && t._zTime) {
                                if (!t._initted && U(t, e, n, i)) return;
                                for (o = t._zTime, t._zTime = e || (i ? Zt : 0), i = i || e && !o, t.ratio = a, t._from && (a = 1 - a), t._time = 0, t._tTime = f, r = t._pt; r;) r.r(a, r.d), r = r._next;
                                t._startAt && e < 0 && t._startAt.render(e, !0, !0), t._onUpdate && !i && Oi(t, "onUpdate"), f && t._repeat && !i && t.parent && Oi(t, "onRepeat"), (e >= t._tDur || e < 0) && t.ratio === a && (a && z(t, 1), i || (Oi(t, a ? "onComplete" : "onReverseComplete", !0), t._prom && t._prom()))
                        ...
                        var n, s, o, u, a, h, f, c = this._targets,
                            l = t ? xi(t) : c,
                            v = this._ptLookup,
                            d = this._pt;
                        ...
                        for (n = this._op = this._op || [], "all" !== e && (r(e) && (a = {}, M(e, (function(t) {
                                return a[t] = 1
                            })), e = a), e = function(t, e) {
                                var i, n, r, s, o = t[0] ? y(t[0]).harness : 0,
                                    u = o && o.aliases;
                                if (!u) return e;
                                for (n in i = mi({}, e), u)
                                    if (n in i)
                                        for (r = (s = u[n].split(",")).length; r--;) i[s[r]] = i[n];
                                return i
                            }(c, e)), f = c.length; f--;)
                            if (~l.indexOf(c[f]))
                                for (a in s = v[f], "all" === e ? (n[f] = e, u = s, o = {}) : (o = n[f] = n[f] || {}, u = e), u)(h = s && s[a]) && ("kill" in h.d && !0 !== h.d.kill(a) || T(this, h, "_pt"), delete s[a]), "all" !== o && (o[a] = 1);
            ...
            function ln(t, e, i, n, r, s, o, u, a) {
                this.t = e, this.s = n, this.c = r, this.p = i, this.r = s || en, this.d = o || this, this.set = u || Ki, this.pr = a || 0, (this._next = t) && (t._prev = this)
            }
            M(gi + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger", (function(t) {
                return hi[t] = 1
            })), ai.TweenMax = ai.TweenLite = Hi, ai.TimelineLite = ai.TimelineMax = Ni, wt = new Ni({
                sortChildren: !1,
                defaults: Ut,
            ...
            var vn = {
                registerPlugin: function() {
                    ...
                    e.forEach((function(t) {
                        return function(t) {
                            ...
                            if (Ai(), t !== n) {
                                if (li[e]) return;
                                C(n, C(E(t, r), o)), mi(n.prototype, mi(r, E(t, o))), li[n.prop = e] = n, t.targetTest && (pi.push(n), hi[e] = 1), e = ("css" === e ? "CSS" : e.charAt(0).toUpperCase() + e.substr(1)) + "Plugin"
                            }
                ...
                quickSetter: function(t, e, i) {
                    ...
                    var s = li[e],
                        ...
                        a = s ? function(n) {
                            var e = new s;
                            kt._pt = 0, e.init(t, i ? n + i : n, kt, 0, [t]), e.render(1, e), kt._pt && un(1, kt)
                        } : o.set(t, u);
                    return s ? a : function(n) {
                        return a(t, u, i ? n + i : n, o, 1)
                    }
                },
                ...
                registerEffect: function(t) {
                    ...
                    (e || "").split(",").forEach((function(t) {
                        return t && !li[t] && !ai[t] && g(i + " effect requires " + t + " plugin.")
                    })), vi[i] = function(t, e, i) {
                ...
                utils: {
                    ...
                    interpolate: function t(e, i, n, s) {
                        ...
                        if (!o) {
                            var u, a, h, f, c, l = r(e),
                                v = {};
                            if (!0 === n && (s = 1) && (n = null), l) e = {
                                p: e
                            }, i = {
                                p: i
                            };
                            else if (ti(e) && !ti(i)) {
                                for (h = [], f = e.length, c = f - 2, a = 1; a < f; a++) h.push(t(e[a - 1], e[a]));
                                f--, o = function(t) {
                                    t *= f;
                                    var e = Math.min(c, ~~t);
                                    return h[e](t - e)
                            ...
                            if (!h) {
                                for (u in i) Wi.call(v, e, u, "get", i[u]);
                                o = function(t) {
                                    return un(t, v) || (l ? e.p : e)
                                }
                            }
                        }
                        return q(n, o)
                    ...
                    init: function(t, n, e) {
                        e._onInit = function(t) {
                            ...
                            if (r(n) && (e = {}, M(n, (function(t) {
                                ...
                                for (i in e)
                                    for (n = s.length; n--;)(r = (r = t._ptLookup[n][i]) && r.d) && (r._pt && (r = dn(r, i)), r && r.modifier && r.modifier(e[i], t, s[n], i))
                            }(t, n)
                        }
                    }
                }
            ...
            function An(t, e, i) {
                ...
                return n[e] || n.getPropertyValue(e.replace(kr, "-$1").toLowerCase()) || n.getPropertyValue(e) || !i && An(t, Er(e) || e, 1) || ""
            }

            function In() {
                void 0 !== i && i.document && ($n = i.document, Jn = $n.documentElement, tr = Cn("div") || {
                    style: {}
                }, Cn("div"), Cr = Er(Cr), Ar = Cr + "Origin", tr.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", nr = !!Er("perspective"), Kn = 1)
            }

            function En(t) {
                var e, i = Cn("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"),
                    n = this.parentNode,
                    r = this.nextSibling,
                    s = this.style.cssText;
                if (Jn.appendChild(i), i.appendChild(this), this.style.display = "block", t) try {
                    e = this.getBBox(), this._gsapBBox = this.getBBox, this.getBBox = En
            ...
            function Tn(e) {
                ...
                return t && (t.width || t.height) || e.getBBox === En || (t = En.call(e, !0)), !t || t.width || t.x || t.y ? t : {
                    x: +Rn(e, ["x", "cx", "x1"]) || 0,
                    y: +Rn(e, ["y", "cy", "y1"]) || 0,
                    width: 0,
                    height: 0
            ...
            function Dn(t, e) {
                if (e) {
                    var i = t.style;
                    e in Mr && e !== Ar && (e = Cr), i.removeProperty ? ("ms" !== e.substr(0, 2) && "webkit" !== e.substr(0, 6) || (e = "-" + e), i.removeProperty(e.replace(kr, "-$1").toLowerCase())) : i.removeAttribute(e)
                }
            }
            ...
            function Ln(t, e, i, n) {
                var r, s, o, u, a = parseFloat(i) || 0,
                    h = (i + "").trim().substr((a + "").length) || "px",
                    f = tr.style,
                    c = Pr.test(e),
            ...
            function Yn(t, e, i, n) {
                ...
                var o, u, a, h, f, c, l, v, d, p, g, m, w = new cn(this._pt, t.style, e, 0, 1, on),
                    y = 0,
                    b = 0;
                if (w.b = i, w.e = n, i += "", "auto" == (n += "") && (t.style[e] = n, n = An(t, e) || n, t.style[e] = i), ct(o = [i, n]), n = o[1], a = (i = o[0]).match(ri) || [], (n.match(ri) || []).length) {
                    for (; u = ri.exec(n);) l = u[0], d = n.substring(y, u.index), f ? f = (f + 1) % 5 : "rgba(" !== d.substr(-5) && "hsla(" !== d.substr(-5) || (f = 1), l !== (c = a[b++] || "") && (h = parseFloat(c) || 0, g = c.substr((h + "").length), (m = "=" === l.charAt(1) ? +(l.charAt(0) + "1") : 0) && (l = l.substr(2)), v = parseFloat(l), p = l.substr((v + "").length), y = ri.lastIndex - p.length, p || (p = p || Qt.units[e] || g, y === n.length && (n += p, w.e += p)), g !== p && (h = Ln(t, e, c, p) || 0), w._pt = {
                        _next: w._pt,
                        p: d || 1 === b ? d : ",",
                        s: h,
                        c: m ? m * v : v - h,
            ...
            function Nn(t, e) {
                if (e.tween && e.tween._time === e.tween._dur) {
                    var i, n, r, s = e.t,
                        ...
                        u = e.u,
                        a = s._gsap;
                    if ("all" === u || !0 === u) o.cssText = "", n = 1;
                    else
                        for (r = (u = u.split(",")).length; - 1 < --r;) i = u[r], Mr[i] && (n = 1, i = "transformOrigin" === i ? Ar : Cr), Dn(s, i);
                    n && (Dn(s, Cr), a && (a.svg && s.removeAttribute("transform"), Lr(s, 1), a.uncache = 1))
                }
            }
            ...
            function qn(t, e, i, n, s, o) {
                var u, a, h = 360,
                    ...
                    l = o ? c * o : c - n,
                    v = n + l + "deg";
                return f && ("short" === (u = s.split("_")[1]) && (l %= h) != l % 180 && (l += l < 0 ? h : -h), "cw" === u && l < 0 ? l = (l + 36e9) % h - ~~(l / h) * h : "ccw" === u && 0 < l && (l = (l - 36e9) % h - ~~(l / h) * h)), t._pt = a = new cn(t._pt, e, i, n, l, wn), a.e = v, a.u = "deg", t._props.push(i), a
            }
            ...
            function Hn(t, e, i) {
                var n, r, s, o, u, a, h, f = Gn({}, i._gsap),
                    c = i.style;
                for (r in f.svg ? (s = i.getAttribute("transform"), i.setAttribute("transform", ""), c[Cr] = e, n = Lr(i, 1), Dn(i, Cr), i.setAttribute("transform", s)) : (s = getComputedStyle(i)[Cr], c[Cr] = e, n = Lr(i, 1), c[Cr] = s), Mr)(s = f[r]) !== (o = n[r]) && "perspective,force3D,transformOrigin,svgOrigin".indexOf(r) < 0 && (u = G(s) !== (h = G(o)) ? Ln(i, r, s, h) : parseFloat(s), a = parseFloat(o), t._pt = new cn(t._pt, n, r, u, a - u, mn), t._pt.u = h || 0, t._props.push(r));
                Gn(n, f)
            }
            Hi.version = Ni.version = gn.version = "3.6.1", _t = 1, l() && Ai();
            var $n, Jn, Kn, tr, ir, nr, rr = Ii.Power0,
                er = Ii.Power1,
                sr = Ii.Power2,
                or = Ii.Power3,
                ur = Ii.Power4,
                ...
                Ur = function(t, e) {
                    var i = e || this,
                        ...
                        b = "auto" === g && t && 1 !== t || !0 === g;
                    if (w && (f !== jr || h !== jr)) {
                        var M, x = parseFloat(h) * _r,
                            _ = Math.sin(x),
                            O = Math.cos(x);
                        x = parseFloat(f) * _r, s = Vn(m, s, _ * (M = Math.cos(x)) * -w), o = Vn(m, o, -Math.sin(x) * -w), u = Vn(m, u, O * M * -w + w)
                    }
                    p !== Nr && (y += "perspective(" + p + Qr), (n || r) && (y += "translate(" + n + "%, " + r + "%) "), !b && s === Nr && o === Nr && u === Nr || (y += u !== Nr || b ? "translate3d(" + s + ", " + o + ", " + u + ") " : "translate(" + s + ", " + o + Qr), a !== jr && (y += "rotate(" + a + Qr), h !== jr && (y += "rotateY(" + h + Qr), f !== jr && (y += "rotateX(" + f + Qr), c === jr && l === jr || (y += "skew(" + c + ", " + l + Qr), 1 === v && 1 === d || (y += "scale(" + v + ", " + d + Qr), m.style[Cr] = y || "translate(0, 0)"
                },
                Wr = function(t, e) {
                    var i, n, r, s, o, u = e || this,
                        a = u.xPercent,
                        h = u.yPercent,
                        f = u.x,
                        c = u.y,
            ...
            M("padding,margin,Width,Radius", (function(e, t) {
                ...
                zr[1 < t ? "border" + e : e] = function(e, t, i, n, r) {
                    ...
                    o = (n + "").split(" "), u = {}, s.forEach((function(t, e) {
            ...
            var Zr, Vr, qr = {
                ...
                init: function(t, e, i, n, r) {
                    var s, o, u, a, h, f, c, l, v, d, g, m, w, y, b, M = this._props,
                        x = t.style,
                        _ = i.vars.startAt;
                    for (c in Kn || In(), e)
                        if ("autoRound" !== c && (o = e[c], !li[c] || !Qi(c, e, i, n, t, r)))
                            if (h = typeof o, f = zr[c], "function" === h && (h = typeof(o = o.call(i, n, t, r))), "string" === h && ~o.indexOf("random(") && (o = et(o)), f) f(this, t, c, o, i) && (b = 1);
                            else if ("--" === c.substr(0, 2)) s = (getComputedStyle(t).getPropertyValue(c) + "").trim(), o += "", Si.lastIndex = 0, Si.test(s) || (l = G(s), v = G(o)), v ? l !== v && (s = Ln(t, c, s, v) + v) : l && (o += l), this.add(x, "setProperty", s, o, n, r, 0, 0, c);
                    else if ("undefined" !== h) {
                        if (_ && c in _ ? (s = "function" == typeof _[c] ? _[c].call(i, n, t, r) : _[c], c in Qt.units && !G(s) && (s += Qt.units[c]), "=" === (s + "").charAt(1) && (s = Xn(t, c))) : s = Xn(t, c), a = parseFloat(s), (d = "string" === h && "=" === o.charAt(1) ? +(o.charAt(0) + "1") : 0) && (o = o.substr(2)), u = parseFloat(o), c in Fr && ("autoAlpha" === c && (1 === a && "hidden" === Xn(t, "visibility") && u && (a = 0), Bn(this, x, "visibility", a ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), "scale" !== c && "transform" !== c && ~(c = Fr[c]).indexOf(",") && (c = c.split(",")[0])), g = c in Mr)
                            if (m || ((w = t._gsap).renderTransform && !e.parseTransform || Lr(t, e.parseTransform), y = !1 !== e.smoothOrigin && w.smooth, (m = this._pt = new cn(this._pt, x, Cr, 0, 1, w.renderTransform, w, 0, -1)).dep = 1), "scale" === c) this._pt = new cn(this._pt, w, "scaleY", w.scaleY, d ? d * u : u - w.scaleY), M.push("scaleY", c), c += "X";
                            else {
                                if ("transformOrigin" === c) {
                                    o = jn(o), w.svg ? Zn(t, o, 0, y, 0, this) : ((v = parseFloat(o.split(" ")[2]) || 0) !== w.zOrigin && Bn(this, w, "zOrigin", w.zOrigin, v), Bn(this, x, c, Xr(s), Xr(o)));
                                    continue
                                }
                                if ("svgOrigin" === c) {
                                    Zn(t, o, 1, y, 0, this);
                        ...
                        else c in x || (c = Er(c) || c);
                        if (g || (u || 0 === u) && (a || 0 === a) && !Sr.test(o) && c in x) u = u || 0, (l = (s + "").substr((a + "").length)) !== (v = G(o) || (c in Qt.units ? Qt.units[c] : l)) && (a = Ln(t, c, s, v)), this._pt = new cn(this._pt, g ? w : x, c, a, d ? d * u : u - a, g || "px" !== v && "zIndex" !== c || !1 === e.autoRound ? mn : bn), this._pt.u = v || 0, l !== v && (this._pt.b = s, this._pt.r = yn);
                ...
                getSetter: function(t, e, i) {
                    var n = Fr[e];
                    return n && n.indexOf(",") < 0 && (e = n), e in Mr && e !== Ar && (t._gsap.x || Xn(t, "x")) ? i && ir === i ? "scale" === e ? Pn : kn : (ir = i || {}) && ("scale" === e ? Sn : Fn) : t.style && !h(t.style[e]) ? _n : ~e.indexOf("-") ? On : rn(t, e)
                },
                core: {
                    _removeProperty: Dn,
                    _getMatrix: Wn
            ...
            gn.utils.checkPrefix = Er, Vr = M("x,y,z,scale,scaleX,scaleY,xPercent,yPercent" + "," + (Zr = "rotation,rotationX,rotationY,skewX,skewY") + ",transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", (function(t) {
                Mr[t] = 1
            })), M(Zr, (function(t) {
                Qt.units[t] = "deg", Br[t] = 1
            })), Fr[Vr[13]] = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent," + Zr, M("0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY", (function(t) {
                var e = t.split(":");
                Fr[e[1]] = Vr[e[0]]
        ...
        var r = n.gsap;
        return i.GreenSockGlobals = t, h.H = r.timeline, h.l = r.ticker, h.J = r, h.J
        ...
        function h() {
            o.length && (a += "<ss-word>" + o + "</ss-word>", o = "")
        }

        function f() {
            u.length && (o += i ? "<ss-char>" + u + "</ss-char>" : u, u = "")
        }

        function c() {
            r && (a = a.substring(0, r) + " " + a.substr(r), r = !1)
        }
        for (var l = 0; l < n.length; l++) {
                ...
                if (/\s/.test(v)) h(), !1 === r && (r = a.length);
                    ...
                    if (c(), u += v, "&" === v) {
                        ...
                        if (65039 === d.charCodeAt(0)) {
                            u += d, u += n[l + 2], u += n[l + 3], u += n[l + 4], l += 4, f();
                            continue
                        }
            ...
            else "/" !== d ? (c(), h(), r = !1) : h(), s = !0, a += v
        }
        return h(), t.innerHTML = a, {
