(function(t) {
    ...
    var s = t.document,
        ...
        f = function(t, i = null, n = null, h = null) {
            const o = s.createElement(t);
            return i && ("string" == typeof i ? N(o, i) : U(o, i)), n && A(o, n), h && O(o, h), o
        },
        l = function(t, i, s, n, h) {
            const o = f(i, s, n, h);
            return t && t.appendChild(o), o
        },
        d = function(t, i, s, n, h) {
            const o = f(t, s, n, h);
            return o.innerHTML = i, o
        },
        v = function(t, i, s, n, h, o) {
            const r = l(t, i, n, h, o);
        ...
        m = function(t, i, s, n) {
            return l(t, "div", i, s, n)
        },
        b = function(t, i, s, n) {
            return d("div", t, i, s, n)
        },
        S = function(t, i, s, n, h) {
            return v(t, "div", i, s, n, h)
        },
        w = function(t, i, s, n, h) {
            const o = f("a", s, n, h);
            return x(o, "href", i), o.innerHTML = t, o
        },
        y = function(t, i, s, n, h, o) {
            const r = l(t, "a", n, h, o);
            return x(r, "href", s), r.innerHTML = i, r
        },
        g = Object.assign,
        k = function(t, i) {
            for (var s = Object(t), n = 1; n < arguments.length; n++) {
                var h = arguments[n];
                if (null !== h && h !== o)
                    for (var r in h) null !== h[r] && Object.prototype.hasOwnProperty.call(h, r) && ("object" == typeof h[r] && (h[r].constructor === Object || Array.isArray(h[r])) ? (Array.isArray(h[r]) ? s[r] = [] : ("object" != typeof s[r] || Array.isArray(s[r])) && (s[r] = {}), s[r] = k(s[r], h[r])) : s[r] = h[r])
            }
            return s
        },
        C = function(t, i) {
        ...
        X = function(t, i) {
            i.childNodes.length ? tt(t, i.childNodes[0]) : i.appendChild(t)
        },
        J = function(t, i) {
            i.nextSibling ? tt(t, i.nextSibling) : i.parentNode.appendChild(t)
        },
        tt = function(t, i) {
        ...
        st = function(t, i, s) {
            return s = g({
                bubbles: !0,
                cancelable: !0
            }, s), it(t, new Event(i, s))
        },
        nt = function(t, i) {
            return it(t, new Event(i, {
                bubbles: !1,
                cancelable: !1
            }))
        },
        ht = function(t, i, s) {
            return it(t, new CustomEvent(i, {
                bubbles: !1,
                cancelable: !1,
                detail: s
            }))
        ...
        gt = function(t, i, s, n) {
            if (Math.abs(t.scrollTop - i) < 1) n && n();
                ...
                var h = t.scrollTop,
                    ...
                    r = performance.now(),
                    u = function(i) {
                        var a = Math.min(1, (i - r) / s);
                        a < .5 ? a *= 2 * a : a = (4 - 2 * a) * a - 1, t.scrollTop = h + a * o, a < 1 ? requestAnimationFrame(u) : n && n()
                    };
                u(r)
            }
        },
        kt = function(t, i, n) {
            ...
            return i && (xt(h, i), n && n.appendChild(h)), h
        },
        Ct = function(t, i, s) {
            t.setAttributeNS(null, i, s)
        },
        xt = function(t, i) {
            for (var s in i) Ct(t, s, i[s])
        },
        At = function(t) {
            return t.charAt(0).toUpperCase() + t.slice(1)
        },
        Pt = navigator.userAgent.indexOf("+http://www.google.com/bot.html") > -1 ? function(t) {
            t()
        } : i.requestIdleCallback || function(t) {
            return r(t, 1)
        },
        It = i.cancelIdleCallback || function(t) {
            u(t)
        },
        Mt = function(t, i) {
            i = (((i || "") + "").toLowerCase().match(/<[a-z][a-z0-9]*>/g) || []).join("");
            return (t + "").replace(/<!--[\s\S]*?-->|<\?(?:php)?[\s\S]*?\?>/gi, "").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*>/gi, (function(t, s) {
                return i.indexOf("<" + s.toLowerCase() + ">") > -1 ? t : ""
            }))
        },
        Ft = function(t, i = "") {
            return Rt(Mt(t, "<a><span><sub><sup><em><i><var><cite><b><strong><small><bdo><br><img><picture><source><u><del><bdi><ins>" + i))
        },
        Rt = function(t) {
            var i = new RegExp(["onclick", "onfocus", "ondrag", "onmouse", "onwheel", "onscroll", "ontouch", "onload", "onerror"].join("|"), "gi");
            return t.replace(i, "not-allowed")
        };
    ...
    yt((function() {
        h = s.body
    })), a.d("SmartSliderBackgrounds", (function() {
        function t(t) {
        ...
        return t.prototype.preLoad = function(t) {
            ...
            this.onSlideDeviceChanged(this.slider.responsive.getDeviceMode()), ut(this.slider.sliderElement, "SliderDevice", function(e) {
            ...
            1 === this.lazyLoad ? (this.preLoadSlides = this.preloadSlidesLazyNeighbor, this.preLoad(this.preLoadSlides(this.slider.getVisibleSlides(this.slider.currentSlide)))) : 2 === this.lazyLoad ? (this.preLoadSlides = this._preLoadSlides, this.slider.stages.done("SlidesReady", function() {
                a.r("windowLoad", this.preLoadAll.bind(this))
            }.bind(this)), this.preLoad(this.preLoadSlides(this.slider.getVisibleSlides(this.slider.currentSlide)))) : (this.preLoadSlides = this._preLoadSlides, this.preLoad(this.preLoadAll())), ut(this.slider.sliderElement, "visibleSlidesChanged", this.onVisibleSlidesChanged.bind(this))
            ...
            if (this.slider.stages.resolved("Visible"))
                for (var o = 0; o < i.length; o++) this.slider.v.addPromise(i[o]);
            return i
        }, t
    })), zt("litespeed-optm-css-rules"), zt("rocket-critical-css"), a.d("SmartSliderLoad", (function() {
        ...
        return s.prototype.start = function() {
            ...
            return this.slider.sliderElement.querySelectorAll(".n2-ss-layers-container").forEach((function(i) {
                a.ImagesLoaded(i), t.push(a.ImagesLoaded(i))
            })), Promise.all(t)
            ...
            this.slider.stages.resolve("BeforeShow"), this.slider.widgets.onReady(), a.MW.U(function() {
                N(this.slider.responsive.alignElement, "n2-ss-align-visible"), N(this.slider.sliderElement, "n2-ss-loaded"), G(this.slider.sliderElement, "n2notransition"), requestAnimationFrame((function() {
                    st(i, "scroll")
                })), Pt(this.slider.startVisibilityCheck.bind(this.slider), {
                    timeout: 2e3
                })
            }.bind(this)), this.slider.stages.resolve("Show")
        }, s
    })), a.d("SmartSliderPlugins", (function() {
        function t(t) {
        ...
        t.prototype.makeReady = function(t, i) {
            ...
            var s = i.split(","),
                ...
                h = n.ssLastEvent;
            t.ssResetEvents || (t.ssResetEvents = 1, ut(n, "layerAnimationPlayIn", function(t) {
                t.ssLastEvent = ""
            }.bind(this, n)));
            for (var o = s.length - 1, r = 0; r < s.length; r++) s[r] === h && (o = r);
            i = o === s.length - 1 ? s[0] : s[o + 1], n.ssLastEvent = i, nt(n, "ss" + i)
            ...
            this.isClickAllowed(e) && (a._shouldPreventClick || (e.preventDefault(), this.applyAction.apply(this, arguments)))
            ...
            if (this.isClickAllowed(e)) {
                var s = z(e.currentTarget, "href");
                if (t === o && (t = z(e.currentTarget, "target")), "_blank" === t) {
                    var n = i.open();
        ...
        var r = {
            ...
            to: function(t) {
                ...
                "smooth" === T(n, "scroll-behavior") ? h.scrollTop = t : gt(h, t, i.n2ScrollSpeed || 400)
            },
            top: function() {
                r.to(0)
            },
            ...
            before: function(t) {
                r.to(wt(t) - i.innerHeight)
            },
            after: function(t) {
                r.to(wt(t) + St(t) - r.focusOffsetTop)
            },
            next: function(t, i) {
            ...
            element: function(t) {
                "string" == typeof t && (t = s.querySelector(t)), r.to(wt(t) - r.focusOffsetTop)
            }
        };
    ...
    })), a.d("SmartSliderAbstract", (function() {
        function t(s, n) {
            ...
            this.stages = new a.Stages, a.d("#" + s, function() {
                return this
            }.bind(this)), this.isAdmin = !!n.admin, a.SmartSliderPlugins.addSlider(this), this.id = parseInt(s.replace("n2-ss-", "")), i[s] = this, n.isDelayed !== o && n.isDelayed ? yt(function() {
        ...
        t.prototype.kill = function() {
            ...
            t ? Y(t) : a.r("documentReady", function() {
                Y(this.sliderElement.closest(".n2-ss-margin"))
            }.bind(this));
            var i = this.sliderElement.closest(".n2-ss-align");
            i ? Y(i) : a.r("documentReady", function() {
                Y(this.sliderElement.closest(".n2-ss-align"))
            ...
            if (i.IntersectionObserver) new IntersectionObserver(function(t, i) {
                ...
                var n = [],
                    h = function() {
                        ...
                        0 === c.length && (ot(n), a.SmartSliderApi.off("SliderResize", h))
                    };
                n.push(rt(i, "resize", h, {
                    capture: !0
                })), n.push(rt(i, "scroll", h, {
                    capture: !0,
                    passive: !0
                })), a.SmartSliderApi.on("SliderResize", h), h()
            }
        }
        return t.prototype.onSliderExists = function(t, s, n) {
            if (this.__sliderElement = n, this.m = n.closest(".n2-section-smartslider"), this.v = this.m.querySelector("ss3-loader"), this.stages.resolve("Exists"), "TEMPLATE" === n.tagName) {
                var h = n.parentNode;
                h.removeChild(n);
                var o = z(n, "loadingType"),
                    u = n.content.children[0],
                    c = function() {
                        h.appendChild(u), E(this.m, "height"), this.waitForDimension(u, s), ht(i, "n2Rocket", {
                            sliderElement: u
                        })
                    }.bind(this);
                "afterOnLoad" === o ? a.r("windowLoad", f.bind(this, this.m, c)) : "afterDelay" === o ? r(c, z(n, "loadingDelay")) : c()
            ...
            this.stages.resolve("HasDimension"), this.killed = !1, this.isVisible = !0, this.responsive = !1, this.mainAnimationLastChangeTime = 0, this.currentSlide = null, this.currentRealSlide = null, this.staticSlides = [], this.slides = [], this.visibleRealSlides = [], this.visibleSlides = [], t.ss = this, this.sliderElement = t, this.needBackgroundWrap = !1, this.blockCarousel = !1, this.parameters = g({
                plugins: [],
                admin: !1,
                playWhenVisible: 1,
                playWhenVisibleAt: .5,
                ...
                postBackgroundAnimations: !1
            }, n2const.isSamsungBrowser && (this.disabled.layerSplitTextAnimations = !0, this.disabled.postBackgroundAnimations = !0, this.parameters.postBackgroundAnimations && G(this.sliderElement, "n2-ss-feature-post-bg-loader"));
            try {
            ...
            this.widgets = new a.SmartSliderWidgets(this);
            var s;
            if (new a.UniversalEnter(this.sliderElement, function(e) {
                    e.target.closest(".n2-full-screen-widget") || (u(s), !0, N(this.sliderElement, "n2-hover"), this.widgets.setState("hover", !0), at(this.sliderElement, "universalleave", function(e) {
                        e.stopPropagation(), s = r(function() {
                            !1, G(this.sliderElement, "n2-hover"), this.widgets.setState("hover", !1)
                        }.bind(this), 1e3)
                    }.bind(this)))
                }.bind(this)), this.parameters.carousel || this.initNotCarousel(), this.initHideArrow(), this.controls = {}, this.parameters.blockrightclick && ut(this.sliderElement, "contextmenu", (function(e) {
                    e.preventDefault()
                })), this.initMainAnimation(), this.initResponsiveMode(), !this.killed) {
                if (ut(this.sliderElement, "touchstart", function() {
                        G(this.sliderElement, "n2-has-hover")
                    }.bind(this), {
                        passive: !0,
                        once: !0
                    ...
                    this.hasTouch() && (n = "n2click"), this.sliderElement.querySelectorAll('[data-n2click="url"]').forEach((function(t) {
                        ut(t, n, (function(e) {
                            n2ss.openUrl(e)
                        })), ut(t, "mousedown", (function(e) {
                            2 !== e.which && 4 !== e.which || (e.preventDefault(), n2ss.openUrl(e, "_blank"))
                        })), ut(t, "keydown", (function(e) {
                            n2ss.openUrlKeyDown(e)
                        }))
                    }))
                }
                this.load.start(), ut(this.sliderElement, "keydown", (function(t) {
                    "Space" !== t.code && "Enter" !== t.code || t.target.matches('[role="button"],[tabindex]') && t.target.matches(":not(a,input,select,textarea)") && (t.preventDefault(), t.target.click(), nt(t.target, "n2Activate"))
                })), ut(this.sliderElement, "mouseleave", (function(e) {
            ...
            for (t = 0; t < this.slides.length; t++) this.slides[t].init(), 1 == +z(this.slides[t].element, "first") && (this.originalRealStarterSlide = this.slides[t]);
            this.realSlides = this.slides, this.visibleSlides = this.slides, this.initSlidesEnd()
        }, t.prototype.initSlidesEnd = function() {
            this.afterRawSlidesReady(), this.stages.resolve("RawSlides"), this.randomize(this.realSlides), this.stages.resolve("RawSlidesOrdered"), this.tt()
        }, t.prototype.tt = function() {
            for (var t = this.sliderElement.querySelectorAll(".n2-ss-static-slide"), i = 0; i < t.length; i++) this.staticSlides.push(new a.FrontendSliderStaticSlide(this, t[i]))
        }, t.prototype.createSlide = function(t, i) {
            return new a.FrontendSliderSlide(this, t, i)
        }, t.prototype.afterRawSlidesReady = function() {}, t.prototype.u = function(t, i) {
            ht(this.sliderElement, t, i)
        }, t.prototype.publicDispatchEvent = function(t, i) {
            this.u(t, i), a.SmartSliderApi.dispatch(t, this)
            ...
            return this.sliderElement.querySelector('.n2-ss-slide-background[data-public-id="' + z(t.element, "slidePublicId") + '"]')
            ...
            if (this.isAdmin) this.finalizeStarterSlideComplete(t);
                ...
                this.overrideStarterSlideIndex(s), ut(this.sliderElement, "mainAnimationComplete", function(e) {
            ...
            t !== o && t.isVisible || (t = this.visibleRealSlides[0]), t !== o ? this.finalizeStarterSlideComplete2(t) : (this.hide(), at(this.sliderElement, "SliderResize", function() {
            ...
            if (!this.isAdmin && this.parameters.playWhenVisible && i.IntersectionObserver) {
                ...
                o.observe(this.sliderElement), this.it = [h.disconnect.bind(h), o.disconnect.bind(o), rt(this.sliderElement, "pointerover", this._markVisible.bind(this))]
            } else this.stages.resolve("Visible")
        }, t.prototype._markVisible = function() {
            this.it && ot(this.it), this.stages.resolve("Visible")
            ...
            if (this.responsive.parameters.focusUser && !t && (s = !0), s) {
                var n = vt(),
                    ...
                    l = "";
                "top-force" === f ? l = "top" : "bottom-force" === f ? l = "bottom" : a <= 0 && c <= 0 || a > 0 && c > 0 || (a < 0 ? l = "top" === f ? "top" : "bottom" === f ? "bottom" : -a <= c ? "top" : "bottom" : c < 0 && (l = "top" === f ? "top" : "bottom" === f || -c <= a ? "bottom" : "top"));
                var d = n;
                if ("top" === l ? d = n - h + u.top : "bottom" === l && (d = n + o + u.bottom - r), (d = Math.round(d)) !== n) return this._scrollTo(d, Math.abs(n - d))
            }
            return !0
        }, t.prototype._scrollTo = function(t, h) {
            var o = !1;
            return "smooth" === T(n, "scroll-behavior") && (_(n, "scroll-behavior", ""), o = !0), i.nextendScrollFocus = !0, new Promise((function(i) {
                gt(s.scrollingElement, t, h, i)
            })).then((function() {
                o && _(n, "scroll-behavior", "smooth"), i.nextendScrollFocus = !1
            }))
            ...
            this.stages.done("StarterSlide", function() {
                t(this.currentSlide), ut(this.sliderElement, "SliderResize", function() {
                    t(this.currentSlide)
                }.bind(this))
            }.bind(this)), ut(this.sliderElement, "SlideWillChange", (function(e) {
                ...
                return Promise.all([Promise.all(this.backgrounds.preLoadSlides(this.getVisibleSlides(this.slides[t]))), this.focus(s)]).then(function() {
                    if (t !== this.currentSlide.index) {
                        if (this.mainAnimationLastChangeTime < h) {
                            ...
                            if ("ended" === r) {
                                s === o && (s = !1);
                                var u = this.mainAnimation;
                                n !== o && (u = n), this._changeTo(t, i, s, n), u.changeTo(this.currentSlide, this.slides[t], i, s), this._changeCurrentSlide(t)
                            } else "initAnimation" !== r && "playing" !== r || (this.__fastChangeRemoveCallback && this.__fastChangeRemoveCallback(), this.__fastChangeRemoveCallback = rt(this.sliderElement, "mainAnimationComplete", function() {
            ...
            this.setCurrentRealSlide(this.slides[t]), this.u("sliderChangeCurrentSlide")
        }, t.prototype._changeTo = function(t, i, s, n) {}, t.prototype.revertTo = function(t, i) {
            this.slides[i].unsetActive(), this.slides[t].setActive(), this._changeCurrentSlide(t), this.u("SlideWillChange", {
                targetSlide: this.slides[t]
            })
            ...
            if (!this.parameters.admin) {
                if (this.hasTouch()) switch (this.parameters.controls.touch) {
                    case "vertical":
                        new a.SmartSliderControlTouchVertical(this);
                        break;
                    case "horizontal":
                        new a.SmartSliderControlTouchHorizontal(this)
                }
                this.parameters.controls.keyboard && (this.controls.touch !== o ? new a.SmartSliderControlKeyboard(this, this.controls.touch.axis) : new a.SmartSliderControlKeyboard(this, "horizontal")), this.parameters.controls.mousewheel && new a.SmartSliderControlMouseWheel(this, this.parameters.controls.mousewheel), this.controlAutoplay = new a.SmartSliderControlAutoplay(this, this.parameters.autoplay), a.SmartSliderControlFullscreen.isSupported && (this.controlFullscreen = new a.SmartSliderControlFullscreen(this)), this.parameters.alias.id && new a.SmartSliderControlAlias(this, this.parameters.alias)
            }
            ...
            if (o && (o = o.closest(".n2-ss-slider")), o) return this.id === o.ss.id || (gt(s.scrollingElement, wt(o), 400), o.ss.slideToID(t, i, !0))
            ...
            this.isVisible && (N(this.responsive.alignElement, "n2-ss-slider-has-no-slide"), this.load.placeholder && N(this.load.placeholder, "n2-ss-slider-has-no-slide"), this.isVisible = !1)
        }, t.prototype.show = function() {
            this.isVisible || (N(this.responsive.alignElement, "n2-ss-slider-has-no-slide"), this.load.placeholder && G(this.load.placeholder, "n2-ss-slider-has-no-slide"), st(i, "scroll"), this.isVisible = !0)
    ...
    })), a.d("SmartSliderWidget", (function() {
        "use strict";
    ...
    })), a.d("SmartSliderWidgets", (function() {
        function t(t) {
        ...
        return t.prototype.register = function(t, i) {
            ...
            this.advancedElement = this.slider.sliderElement.querySelector(".n2-ss-slider-controls-advanced"), this.requiredVariables = this.advancedElement ? (z(this.advancedElement, "variables") || "").split(",") : [], ut(this.slider.sliderElement, "visibleSlidesChanged", function() {
            ...
            for (var i in this.controls)
                if (this.controls[i] !== o) {
                    var s = z(this.controls[i].widget, "excludeSlides");
                    if (s !== o) {
            ...
            if (t) {
                ...
                }), ut(this.slider.sliderElement, "SlideWillChange", f)
            }
            this.requiredVariables.length && this.advancedElement && (this.flushAdvancedVariables(), ut(this.slider.sliderElement, "SliderResize", this.flushAdvancedVariables.bind(this))), this.onStateChangeAll(), this.slider.stages.resolve("WidgetsReady"), this.advancedElement && this.slider.stages.done("BeforeShow", function() {
                N(this.advancedElement, "n2-ss-slider-controls-advanced--ready")
            }.bind(this))
            ...
            for (var s in t) _(this.advancedElement, "--" + s, parseInt(t[s]))
        }, t.prototype.getAdvancedVariable = function(t) {
            var i = this.slider.responsive.resizeContext;
            switch (t) {
                case "outerwidth":
                    return bt(this.sliderElement.parentNode);
                case "outerheight":
            ...
            this.advancedElement && (z(this.advancedElement, "variables") || "").match(t) && this.slider.stages.done("BeforeShow", function() {
                this.flushAdvancedVariables()
            }.bind(this))
        }, t
    })), a.d("SmartSliderMainAnimationAbstract", (function() {
        function t(t, i) {
            this.state = "ended", this.isTouch = !1, this.isReverseAllowed = !0, this.isReverseEnabled = !1, this.reverseSlideIndex = null, this.isNoAnimation = !1, this.slider = t, this.parameters = g({
                duration: 1500,
                ease: "easeInOutQuint"
            }, i), this.parameters.duration = Math.max(.01, this.parameters.duration / 1e3), this.sliderElement = t.sliderElement, this.timeline = new a.H({
                paused: !0
            }), ut(this.sliderElement, "mainAnimationStart", function(e) {
        ...
        return t.prototype.init = function() {
            ...
            this.isReverseEnabled = !0, this.reverseTimeline = new a.H({
                paused: !0
            }), ht(this.slider.sliderElement, "reverseModeEnabled", {
            ...
            ht(this.slider.sliderElement, "mainAnimationWillRevertTo", {
                slideIndex: t,
                originalNextSlideIndex: i
            }), at(this.sliderElement, "mainAnimationComplete", this.revertTo.bind(this, t, i))
        }, t.prototype.revertTo = function(t, i) {
            this.slider.revertTo(t, i), nt(this.slider.slides[i].element, "mainAnimationStartInCancel")
        }, t.prototype.willCleanSlideIndex = function(t) {
            at(this.sliderElement, "mainAnimationComplete", this.cleanSlideIndex.bind(this, t))
            ...
            this.slider.u("mainAnimationStart", n), t.u("mainAnimationStartOut", n), i.u("mainAnimationStartIn", n)
            ...
            this.clearTimelines(), this.disableReverseMode(), t.u("mainAnimationCompleteOut", n), i.u("mainAnimationCompleteIn", n), this.state = "ended", this.slider.updateInsideSlides([i]), s || i.focus(), this.slider.u("mainAnimationComplete", n)
    ...
    })), a.d("SmartSliderControlAlias", (function() {
        "use strict";

        function t(t, s) {
            this.st = t, this.nt = t.sliderElement, this.ht = t.m, this.et = z(this.ht, "alias"), this.ot = g({
                id: 0,
                smoothScroll: 0,
                slideSwitch: 0,
                scroll: 1
            }, s), this.et && (this.ot.smoothScroll && _(n, "scroll-behavior", "smooth"), this.ot.slideSwitch && (this.switchOnLoad(), ut(i, "hashchange", function() {
                var t = this.getAnchor();
                t > 0 && (1 === this.st.responsive.parameters.focusUser ? (this.st.responsive.parameters.focusUser = 0, this.switchToSlide(t - 1), this.st.responsive.parameters.focusUser = 1) : this.switchToSlide(t - 1), this.replaceHash())
            }.bind(this))))
        }
    ...
    })), a.d("SmartSliderControlAutoplay", (function() {
        "use strict";
        ...
        function t(t, i) {
            this.slider = t, this.state = {
                ...
                wait: 0
            }, this._listeners = [], this.wait = new a.SmartSliderControlAutoplayWait(this), this._currentCount = 1, this.autoplayToSlide = 0, this.autoplayToSlideIndex = -1, this.parameters = g({
                enabled: 0,
                start: 1,
                duration: 8e3,
                autoplayLoop: 0,
        ...
        return t.prototype.preventClickHandle = function() {
            ...
            this._listeners.push(rt(t, "SlideLoading", function() {
                this.wait.add("load")
            }.bind(this))), this._listeners.push(rt(t, "SlideLoaded", function(e) {
                this.wait.resolve("load")
            }.bind(this))), this._listeners.push(rt(t, "BeforeCurrentSlideChange", function() {
                this.wait.resolveWeak(), this.setState("mainAnimationPlaying", 1)
            }.bind(this))), this._listeners.push(rt(t, "mainAnimationStart", function() {
                this._currentCount++, this.setState("mainAnimationPlaying", 1), this.wait.resolveWeak()
            }.bind(this))), this._listeners.push(rt(t, "mainAnimationComplete", function(e) {
                this.timeline.duration(this.getSlideDuration(e.detail.currentSlideIndex)), this.rt = !0, this.timeline.pause(0, !1), this.setState("mainAnimationPlaying", 0)
            }.bind(this))), this._listeners.push(rt(t, "autoplayPause", function(e) {
                this.setState("paused", 1)
            }.bind(this))), this._listeners.push(rt(t, "autoplayResume", function(e) {
            ...
            }.bind(this))), this._listeners.push(rt(t, "CurrentSlideChanged", function(e) {
                this.timeline.duration(this.getSlideDuration(e.detail.currentSlide.index)), this.rt = !0, this.timeline.pause(0, !1), this.setState("mainAnimationPlaying", 0)
            ...
            (t || i) && (this.universalClick = new a.UniversalClick(this.slider.sliderElement, function(e) {
            ...
            if (t || i) {
                var s = !1;
                this._listeners.push(rt(this.slider.sliderElement, "touchend", (function() {
                    s = !0, r((function() {
                        s = !1
                    }), 300)
                }))), this._listeners.push(rt(this.slider.sliderElement, "mouseenter", function(e) {
                    this.state.pausedSecondary ? "enter" === i && this.setState("pausedSecondary", 0) : s || "enter" !== t || this.setState("pausedSecondary", 1)
                }.bind(this))), this._listeners.push(rt(this.slider.sliderElement, "mouseleave", function(e) {
            ...
            t ? (this._listeners.push(rt(s, "mediaStarted", function(e) {
                this.wait.add(e.detail.id)
            }.bind(this))), this._listeners.push(rt(s, "mediaEnded", function(e) {
                this.wait.resolve(e.detail.id)
            }.bind(this)))) : i && this._listeners.push(rt(s, "mediaEnded", function() {
            ...
            this.timeline && this.timeline.eventCallback("onUpdate", function() {
                this.slider.u("autoplay", {
                    progress: this.timeline.progress()
                })
            }.bind(this))
        }, t.prototype.next = function() {
            if (this.rt) {
                if (this.rt = !1, this.timeline.pause(), !this.parameters.autoplayLoop) {
            ...
            this.setState("enabled", 0), ot(this._listeners), this.universalClick && (this.universalClick.remove(), delete this.universalClick), this.slider.stages.resolve("AutoplayDestroyed")
    ...
    })), a.d("SmartSliderControlFullscreen", (function() {
        "use strict";

        function t(i, n, h) {
            this.slider = i, this.responsive = this.slider.responsive, this._type = this.responsive.parameters.type, this._upscale = this.responsive.parameters.upscale, this.ut = !1, this.nt = this.slider.sliderElement, this.at = this.nt.closest(".n2-section-smartslider"), ut(s, t.event, this.fullScreenChange.bind(this))
        }
        return t.isSupported = !(!s.exitFullscreen && !s.webkitExitFullscreen), t.isSupported && (t.requestFullscreen = n.requestFullscreen || n.webkitRequestFullscreen, t.exitFullscreen = s.exitFullscreen || s.webkitExitFullscreen, t.event = n.requestFullscreen ? "fullscreenchange" : n.webkitRequestFullscreen ? "webkitfullscreenchange" : null), t.prototype.switchState = function() {
            this.ut = !this.ut, this.ut ? this._fullScreen() : this._normalScreen()
        }, t.prototype.requestFullscreen = function() {
            return !this.ut && (this.ut = !0, this._fullScreen(), !0)
        }, t.prototype.exitFullscreen = function() {
            return !!this.ut && (this.ut = !1, this._normalScreen(), !0)
        }, t.prototype._fullScreen = function() {
            this.responsive.ut = !0, this.responsive.parameters.type = "fullpage", this.nt.dataset.responsive = this.responsive.parameters.type, this.responsive.parameters.upscale = !0, this._marginLeft = this.responsive.containerElement.style.marginLeft, this._marginRight = this.responsive.containerElement.style.marginRight, V(this.responsive.containerElement, {
                marginLeft: 0,
                marginRight: 0
            }), V(this.at, {
                width: "100%",
            ...
            this.isDocumentInFullScreenMode() ? (this.slider.u("n2FullScreen"), N(n, "n2-in-fullscreen"), N(this.slider.sliderElement, "n2-ss-slider--fullscreen"), this.ut = !0, "auto" === this._type && _(this.slider.responsive.alignElement, "max-width", "none"), st(i, "resize")) : (this.responsive.ut = !1, this.responsive.parameters.type = this._type, this.nt.dataset.responsive = this._type, this.responsive.parameters.upscale = this._upscale, V(this.responsive.containerElement, {
                ...
                height: "",
                "background-color": ""
            }), G(this.slider.sliderElement, "n2-ss-slider--fullscreen"), G(n, "n2-in-fullscreen"), "auto" === this._type && E(this.slider.responsive.alignElement, "max-width"), st(i, "resize"), this.ut = !1, this.slider.u("n2ExitFullScreen"))
        }, t.prototype.isDocumentInFullScreenMode = function() {
            return s.fullscreenElement || s.webkitIsFullScreen
        }, t
    })), a.d("SmartSliderControlKeyboard", (function() {
        "use strict";
        var t;
        ...
        function o(i, s, h) {
            this.slider = i, this.parameters = g({}, h), this.parseEvent = "vertical" === s ? o.prototype.parseEventVertical : o.prototype.parseEventHorizontal, t || (t = new n), t.addControl(this), ut(this.slider.sliderElement, "SliderKeyDown", function(e) {
        ...
        return n.prototype.onMouseMove = function(e) {
            ...
            if (e.target.tagName.match(/BODY|DIV|IMG/) && !e.target.isContentEditable) {
                var t;
                if (this.mouseEvent && (t = this.findSlider(s.elementFromPoint(this.mouseEvent.clientX, this.mouseEvent.clientY)))) return void ht(t, "SliderKeyDown", {
                    e: e
                });
                if (s.activeElement !== h && (t = this.findSlider(s.activeElement))) return void ht(t, "SliderKeyDown", {
                    e: e
                });
    ...
    })), a.d("SmartSliderControlMouseWheel", (function() {
        "use strict";
        ...
        function t(t, i) {
            this.preventScroll = {
                ...
                globalTimeout: !1
            }, this.maxDelta = 0, this.slider = t, this.ct = 2 === i ? "deltaX" : "deltaY", s.addEventListener("wheel", this.onGlobalMouseWheel.bind(this), {
                passive: !1
        ...
        return t.prototype.hasScrollableParentVertical = function(t, s) {
            ...
            e.target.closest(".n2-ss-slider") && 0 !== e[this.ct] && (this.onCurveEvent(e), this.preventScroll.local || this.preventScroll.curve || Math.abs(e[this.ct]) < this.maxDelta / 2 ? e.preventDefault() : (this.preventScroll.global && e.preventDefault(), (this.slider.sliderElement === e.target || this.slider.sliderElement.contains(e.target)) && ("deltaY" === this.ct ? e.shiftKey || this.hasScrollableParentVertical(e.deltaY < 0, e.target) || this.onMouseWheel(e) : "deltaX" === this.ct && (this.hasScrollableParentHorizontal(e.target) || this.onMouseWheel(e)))))
        }, t.prototype.onMouseWheel = function(e) {
            e[this.ct] < 0 ? this.slider.isChangeCarousel("previous") && this.slider.parameters.controls.blockCarouselInteraction || (this.slider.previous(), e.preventDefault(), this.startCurveWatcher(e), this.local(), this.global()) : e[this.ct] > 0 && (this.slider.isChangeCarousel("next") && this.slider.parameters.controls.blockCarouselInteraction || (this.slider.next(), e.preventDefault(), this.startCurveWatcher(e), this.local(), this.global()))
        }, t.prototype.startCurveWatcher = function(e) {
            !1 !== this.preventScroll.curve && u(this.preventScroll.curveTimeout), this.preventScroll.curveGlobal || (this.dynamicDelta = !1, this.lastDelta = e[this.ct], this.preventScroll.curveGlobal = !0, this.preventScroll.curveGlobalTimeout = r(function() {
            ...
            if (this.preventScroll.curveGlobal) {
                this.dynamicDelta || this.lastDelta === e[this.ct] || (this.lastDelta = e[this.ct], this.dynamicDelta = !0);
                var t = Math.abs(e[this.ct]);
                this.preventScroll.curve && this.maxDelta / 2 > t && this.releaseCurveLock(), this.maxDelta = Math.max(this.maxDelta, t), this.preventScroll.curveGlobalTimeout && u(this.preventScroll.curveGlobalTimeout), this.preventScroll.curveGlobalTimeout = r(function() {
                    this.preventScroll.curveGlobal = !1, this.maxDelta = 0
                }.bind(this), 500)
            }
        }, t.prototype.releaseCurveLock = function() {
            this.preventScroll.curve = !1, u(this.preventScroll.curveTimeout)
        }, t.prototype.local = function() {
            !1 !== this.preventScroll.local && u(this.preventScroll.localTimeout), this.preventScroll.local = !0, this.preventScroll.localTimeout = r(function() {
                this.preventScroll.local = !1, this.dynamicDelta || this.releaseCurveLock()
            }.bind(this), 1e3)
        }, t.prototype.global = function() {
            !1 !== this.preventScroll.global && u(this.preventScroll.globalTimeout), this.preventScroll.global = !0, this.preventScroll.globalTimeout = r(function() {
                this.preventScroll.global = !1
            }.bind(this), 1e3)
        }, t
    })), a.d("SmartSliderControlTouch", (function() {
        "use strict";

        function t(t) {
            this.slider = t, this.interactiveDrag = !0, this.preventMultipleTap = !1, this._animation = t.mainAnimation, this.swipeElement = this.slider.sliderElement.querySelector(".n2_ss__touch_element"), t.controls.touch = this, t.stages.done("StarterSlide", this.onStarterSlide.bind(this)), ut(t.sliderElement, "visibleSlidesChanged", this.onVisibleSlidesChanged.bind(this))
        }
        return t.prototype.onStarterSlide = function() {
            this.initTouch(), ut(this.slider.sliderElement, "sliderChangeCurrentSlide", this.updatePanDirections.bind(this))
        }, t.prototype.onVisibleSlidesChanged = function() {
            this.slider.visibleSlides.length > 1 ? V(this.swipeElement, {
                cursor: "grab",
                userSelect: "none"
            }) : j(this.swipeElement, ["cursor", "userSelect"])
        }, t.prototype.initTouch = function() {
            this._animation.isNoAnimation && (this.interactiveDrag = !1), this.eventBurrito = a.EventBurrito(this.swipeElement, {
                mouse: !0,
            ...
            if ("switch" === this.currentInteraction.action) {
                ...
                G(this.swipeElement, "n2-grabbing")
            }
            this.onEnd(), delete this.currentInteraction, Math.abs(s.x) < 10 && Math.abs(s.y) < 10 ? this.onTap(t) : a._preventClick()
            ...
            if ("scroll" === this.currentInteraction.action && "pointer" === this.currentInteraction.type) {
                var t = this.currentInteraction.distanceY[0],
                    ...
                    o = function() {
                        requestAnimationFrame(function() {
                            var t, i;
                            if (!this.kineticScrollCancelled && n && (t = Date.now() - h, (i = n * Math.exp(-t / 325)) > 1 || i < -1)) return pt(vt() + i), void o();
            ...
            delete this.kineticScrollCancelled, s.removeEventListener("pointerdown", this.cancelKineticScroll), _(n, "scroll-behavior", "")
            ...
            "vertical" === this.axis && (this.slider.controlFullscreen && this.slider.controlFullscreen.ut || (this.currentInteraction.action = "scroll", "pointer" === this.currentInteraction.type && (_(n, "scroll-behavior", "auto"), pt(Math.max(0, this.currentInteraction.scrollTop - t)))))
            ...
            if ("unknown" === this.currentInteraction.action && this.slider.visibleSlides.length > 1)
                if ("ended" === this._animation.state) {
                    ...
                    if ("unknown" !== t && this.currentInteraction.state[t]) {
                        ...
                        this.currentInteraction.action = "switch", N(this.swipeElement, "n2-grabbing")
                    }
            ...
            this.preventMultipleTap || (st(e.target, "n2click"), this.preventMultipleTap = !0, r(function() {
    ...
    })), a.d("SmartSliderControlTouchHorizontal", "SmartSliderControlTouch", (function() {
        "use strict";
        ...
        function t() {
            this.state = {
                left: !1,
                right: !1
            }, this.axis = "horizontal", a.SmartSliderControlTouch.prototype.constructor.apply(this, arguments)
        }
        return t.prototype = Object.create(a.SmartSliderControlTouch.prototype), t.prototype.constructor = t, t.prototype.callAction = function(t, i) {
            switch (t) {
                case "left":
            ...
            _(this.swipeElement, "touch-action", t), i.PointerEventsPolyfill && x(this.swipeElement, "touch-action", t)
        }, t
    })), a.d("SmartSliderControlTouchVertical", "SmartSliderControlTouch", (function() {
        "use strict";
        ...
        function t() {
            this.state = {
                ...
                up: "next",
                down: "previous"
            }, this.axis = "vertical", a.SmartSliderControlTouch.prototype.constructor.apply(this, arguments)
        }
        return t.prototype = Object.create(a.SmartSliderControlTouch.prototype), t.prototype.constructor = t, t.prototype.callAction = function(t, i) {
            switch (t) {
                case "up":
            ...
            this.slider.blockCarousel = !0, a.SmartSliderControlTouch.prototype._start.apply(this, arguments)
        }, t.prototype.onEnd = function(t) {
            a.SmartSliderControlTouch.prototype.onEnd.apply(this, arguments), this.slider.blockCarousel = !1
        }, t
    })), a.d("SmartSliderControlAutoplayWait", (function() {
        "use strict";
    ...
    })), a.d("SmartSliderSlideBackgroundColor", (function() {
        function t(t, i) {
            this.el = i
        }
    ...
    })), a.d("SmartSliderSlideBackgroundImage", (function() {
        function t(t, i, s, n) {
        ...
        return t.prototype.getLoadPromise = function() {
            ...
            this.blur = z(this.imageElements[0], "blur");
            const t = z(this.imageElements[0].parentElement, "mode"),
                i = [];
            this.blur && i.push({
                item: this.imageElements[this.imageElements.length - 1],
                blur: this.blur
            }), "blurfit" === t && (this.blurFitMode = z(this.imageElements[0], "blurfitmode"), this.globalBlurFit = z(this.imageElements[0], "globalblur"), this.editorBlur = z(this.imageElements[0], "bgblur"), i.push({
                ...
                V(t.item, {
                    margin: -2 * t.blur + "px",
                    padding: 2 * t.blur + "px"
                }), _(t.item.children[0], "filter", "blur(" + t.blur + "px)")
            }));
            ...
            a.J.to(a.MW.L(this.imageElements), .3, {
                opacity: 0
            })
        }, t.prototype.onSlideDeviceChanged = function() {}, t
    })), a.d("SmartSliderSlideBackground", (function() {
        function t(t, i, s) {
        ...
        return t.prototype.preloadOnce = function() {
            if (!this.elements) {
                this.elements = {
                    ...
                    image: !1,
                    video: !1
                }, this.currentSrc = "", this.mode = z(this.element, "mode"), this.opacity = z(this.element, "opacity");
                var t = this.element.querySelectorAll(".n2-ss-slide-background-image");
                t.length && (this.elements.image = new a[this.types.image](this.slide, this.manager, this, t), this.elements.image.preLoad());
                var i = this.element.querySelector(".n2-ss-slide-background-color");
                i && (this.elements.color = new a[this.types.color](this, i)), this.readyPromiseResolve(), delete this.readyPromiseResolve, delete this.readyPromise;
                var s = [];
    ...
    })), a.d("FrontendComponentCommon", ["FrontendComponent"], (function() {
        function t(t, i, s, n) {
            this.wraps = {}, a.FrontendComponent.prototype.constructor.apply(this, arguments)
        }
        return t.prototype = Object.create(a.FrontendComponent.prototype), t.prototype.constructor = t, t.prototype.init = function(t) {
            this.stateCBs = [], this.state = {
                InComplete: !1
            };
            var i = this.layer.querySelector(":scope > .n2-ss-layer-mask");
            switch (i && (this.wraps.mask = i), z(this.layer, "pm")) {
                case "absolute":
                    this.placement = new a.FrontendPlacementAbsolute(this);
                    break;
                case "normal":
                    this.placement = new a.FrontendPlacementNormal(this);
                    break;
                case "content":
                    this.placement = new a.FrontendPlacementContent(this);
                    break;
                default:
                    this.placement = new a.FrontendPlacementDefault(this)
            }
            a.FrontendComponent.prototype.init.call(this, t)
        }, t.prototype.setState = function(t, i) {
            this.state[t] = i;
            ...
            this.placement.start(), a.FrontendComponent.prototype.start.call(this);
            var t = parseFloat(this.get("rotation"));
            t && (a.MW.i(this.layer).layerRotation = t)
        }, t.prototype.onDeviceChange = function(t) {
            a.FrontendComponent.prototype.onDeviceChange.call(this, t);
            ...
            a.FrontendComponent.prototype.onResize.apply(this, arguments), this.placement.onResize(t, i)
    ...
    })), a.d("FrontendComponent", (function() {
        function t(t, i, s, n) {
        ...
        return t.prototype.init = function(t) {
            if (t)
                for (var i = 0; i < t.length; i++) {
                    ...
                    switch (z(s, "sstype")) {
                        case "content":
                            this.children.push(new a.FrontendComponentContent(this.slide, this, s));
                            break;
                        case "row":
                            this.children.push(new a.FrontendComponentRow(this.slide, this, s));
                            break;
                        case "col":
                            this.children.push(new a.FrontendComponentCol(this.slide, this, s));
                            break;
                        default:
                            this.children.push(new a.FrontendComponentLayer(this.slide, this, s))
                    }
                }
        }, t.prototype.start = function() {
            ...
            var s = z(this.layer, this.device + t);
            return s !== o ? s : "desktopportrait" !== this.device ? z(this.layer, "desktopportrait" + t) : i !== o ? i : 0
        }, t.prototype.get = function(t) {
            return z(this.layer, t)
        }, t
    })), a.d("FrontendSlideControls", (function() {
        function t(t, i) {
            this.slider = t, this.element = i, this.element.ssSlide = this, this.status = new a.SlideStatus
        }
    ...
    })), a.d("FrontendPlacement", (function() {
        function t(t) {
            this.layer = t, this.linked = []
        }
        return t.prototype.start = function() {}, t.prototype.onDeviceChange = function(t) {}, t.prototype.ft = function() {
            ...
            return 1 != +z(this.layer.layer, "hide" + this.layer.device)
        }, t.prototype.getPositionSize = function() {
            return g({}, this._sizePosition)
        }, t
    })), a.d("FrontendSliderSlide", ["FrontendSliderSlideAbstract"], (function() {
        function t(t, i, s) {
            this.slides = [this], this.playCount = 0, a.FrontendSliderSlideAbstract.prototype.constructor.apply(this, arguments), this.id = z(i, "id"), this._slideFocus = i.querySelector(".n2-ss-slide--focus"), this.focusableElements = Array.from(i.querySelectorAll('a[href]:not([href=""]),link,button,input:not([type="hidden"]),select,textarea,audio[controls],video[controls],[tabindex]:not([tabindex="-1"])'));
            var n = C(i, "tabindex");
            ("0" === n || +n > 0) && this.focusableElements.push(i), this.disableFocus(), this.background = !1, t.parameters.admin ? this.minimumSlideDuration = 0 : (this.minimumSlideDuration = +z(i, "slideDuration"), this.minimumSlideDuration || (this.minimumSlideDuration = 0)), this._isCurrentlyEdited = this.slider.parameters.admin && i.classList.contains("n2-ss-currently-edited-slide"), this.isCurrentlyEdited() ? (this.layer = i.querySelector('.n2-ss-layer[data-sstype="slide"]'), ut(t.sliderElement, "SliderDeviceOrientation", function() {
                this.slider.visibleRealSlides.push(this), this.isVisible = !0, this.slider.responsive.visibleRealSlidesChanged = !0, this.u("Visible")
            }.bind(this))) : (this.component = new a.FrontendComponentSectionSlide(this, t, i.querySelector('.n2-ss-layer[data-sstype="slide"]')), this.layer = this.component.layer)
        }
        t.prototype = Object.create(a.FrontendSliderSlideAbstract.prototype), t.prototype.constructor = t, t.prototype._setInside = function(t) {
        ...
        return t.prototype.focus = function() {
            ...
            for (var t = 0; t < this.focusableElements.length; t++) x(this.focusableElements[t], "tabindex", 0);
            P(this.element, "aria-hidden")
        }, t.prototype.disableFocus = function() {
            for (var t = 0; t < this.focusableElements.length; t++) x(this.focusableElements[t], "tabindex", -1);
            x(this.element, "aria-hidden", "true")
        }, t.prototype.init = function() {
            var t = this.slider.findSlideBackground(this);
            t && (this.slider.isAdmin ? this.background = new a.SmartSliderSlideBackgroundAdmin(this, t, this.slider.backgrounds) : this.background = new a.SmartSliderSlideBackground(this, t, this.slider.backgrounds)), this.element.ssSlideBackground = this.background
        }, t.prototype.onDeviceChange = function(t) {
            z(this.element, "hide" + At(t)) ? !1 !== this.isVisible && (this.isVisible = !1, this.slider.responsive.visibleRealSlidesChanged = !0, this.u("Hidden")) : (this.slider.visibleRealSlides.push(this), !0 !== this.isVisible && (this.isVisible = !0, this.slider.responsive.visibleRealSlidesChanged = !0, this.u("Visible")))
            ...
            return !!z(this.element, "haslink")
        }, t
    })), a.d("FrontendSliderSlideAbstract", ["FrontendSlideControls"], (function() {
        function t(t, i, s) {
            a.FrontendSlideControls.prototype.constructor.call(this, t, i), this.slides = this.slides || [], this.group = this, this.originalIndex = s, this.index = s, this.localIndex = s, this.groupIndex = 0, this.isVisible = !0, this.isInside = -1
        }
        for (var i in a.FrontendSlideControls.prototype) t.prototype[i] = a.FrontendSlideControls.prototype[i];
        return t.prototype.setIndex = function(t) {
            ...
            return z(this.slides[0].element, "title") || ""
        }, t.prototype.getDescription = function() {
            return z(this.slides[0].element, "description") || ""
            ...
            this.allowFocus(), N(this.element, "n2-ss-slide-active")
        }, t.prototype.unsetActive = function() {
            this.disableFocus(), G(this.element, "n2-ss-slide-active")
    ...
    })), a.d("FrontendSliderStaticSlide", ["FrontendSlideControls"], (function() {
        function t(t, i) {
            a.FrontendSlideControls.prototype.constructor.call(this, t, i), this.slides = [this], this.isVisible = !0, this._isCurrentlyEdited = this.slider.parameters.admin && i.classList.contains("n2-ss-currently-edited-slide"), this.isCurrentlyEdited() ? this.layer = i.querySelector('.n2-ss-layer[data-sstype="slide"]') : (this.component = new a.FrontendComponentSectionSlide(this, t, i.querySelector('.n2-ss-layer[data-sstype="slide"]')), this.layer = this.component.layer)
        }
        for (var i in a.FrontendSlideControls.prototype) t.prototype[i] = a.FrontendSlideControls.prototype[i];
        return t.prototype.isStatic = function() {
            return !0
        }, t.prototype.onDeviceChange = function(t) {
            z(this.element, "hide" + At(t)) ? !1 !== this.isVisible && (this.isVisible = !1, this.u("Hidden")) : !0 !== this.isVisible && (this.isVisible = !0, this.status.is("INITIALIZED") && this.playIn(), this.u("Visible"))
        }, t
    })), a.d("FrontendPlacementAbsolute", ["FrontendPlacement"], (function() {
        var t = new class {
            constructor() {
                this.lt = new Set, this.dt = new Set, this._ = this.O.bind(this)
            }
            add(t) {
                this.lt.add(t)
            }
            invalidate(t) {
                this.dt.add(t), 1 === this.dt.size && a.l.add(this._)
            }
            O() {
                for (let t of this.dt) t.ft();
                for (let t of this.dt) t.onResizeSize();
                for (let t of this.dt) t.onResizePosition();
                this.dt.clear(), a.l.remove(this._)
            }
        };

        function i(t) {
            this.parentLayer = !1, this.parentLayerPlacement = !1, a.FrontendPlacement.prototype.constructor.apply(this, arguments)
        }
        return i.prototype = Object.create(a.FrontendPlacement.prototype), i.prototype.constructor = i, i.prototype.start = function() {
            ...
            if (this.layer.parent instanceof a.FrontendComponentSectionSlide) {
                if (!this.parentLayer) return !1;
                if (this.parentLayer.placement instanceof a.FrontendPlacementAbsolute) return !1
            }
            return !0
        }, i.prototype.ft = function() {
            a.FrontendPlacement.prototype.ft.apply(this, arguments);
            ...
            var o = this.getWidth(n),
                ...
                u = this.getHeight(h),
                c = "number" == typeof u;
            this._sizePosition && (r && (this._sizePosition.width = o, c || (_(this.layer.layer, "width", o + "px"), this._sizePosition.height = this.layer.layer.offsetHeight)), c && (this._sizePosition.height = u)), t.width = o + (r ? "px" : ""), t.height = u + (c ? "px" : "")
            ...
            if (this.parentLayerPlacement && this.parentLayerPlacement.isVisible()) {
                ...
                if (this.parentLayerPlacement instanceof a.FrontendPlacementAbsolute) {
                    var d = a.MW.i(this.parentLayerPlacement.layer.layer);
                ...
                switch (u) {
                    case "right":
                        v = !this.layer.slide.isStatic && this.layer.parent instanceof a.FrontendComponentSectionSlide ? this.St.slideWidth : this.vt.width, s.xAbs = Math.round(v + o), s.xPAbs = -100;
                        break;
                    case "center":
                        v = !this.layer.slide.isStatic && this.layer.parent instanceof a.FrontendComponentSectionSlide ? this.St.slideWidth : this.vt.width, s.xAbs = Math.round(v / 2 + o), s.xPAbs = -50;
                        break;
                    default:
                ...
                switch (c) {
                    case "bottom":
                        p = !this.layer.slide.isStatic && this.layer.parent instanceof a.FrontendComponentSectionSlide ? this.St.slideHeight : this.vt.height, s.yAbs = Math.round(p + r), s.yPAbs = -100;
                        break;
                    case "middle":
                        p = !this.layer.slide.isStatic && this.layer.parent instanceof a.FrontendComponentSectionSlide ? this.St.slideHeight : this.vt.height, s.yAbs = Math.round(p / 2 + r), s.yPAbs = -50;
                        break;
                    default:
            ...
            this.isVisible() && (this.bt = i, this.St = s, t.invalidate(this), a.FrontendPlacement.prototype.onResize.apply(this, arguments))
    ...
    })), a.d("FrontendPlacementContent", ["FrontendPlacement"], (function() {
        function t(t) {
            a.FrontendPlacement.prototype.constructor.apply(this, arguments)
        }
        return t.prototype = Object.create(a.FrontendPlacement.prototype), t.prototype.constructor = t, t
    })), a.d("FrontendPlacementDefault", ["FrontendPlacement"], (function() {
        function t(t) {
            a.FrontendPlacement.prototype.constructor.apply(this, arguments)
        }
        return t.prototype = Object.create(a.FrontendPlacement.prototype), t.prototype.constructor = t, t
    })), a.d("FrontendPlacementNormal", ["FrontendPlacement"], (function() {
        function t(t) {
            a.FrontendPlacement.prototype.constructor.apply(this, arguments)
        }
        return t.prototype = Object.create(a.FrontendPlacement.prototype), t.prototype.constructor = t, t
    })), a.d("FrontendComponentCol", ["FrontendComponentCommon"], (function() {
        function t(t, i, s) {
            this.content = s.querySelector(".n2-ss-layer-col"), a.FrontendComponentCommon.prototype.constructor.call(this, t, i, s, this.content.querySelectorAll(":scope > .n2-ss-layer"))
        }
        return t.prototype = Object.create(a.FrontendComponentCommon.prototype), t.prototype.constructor = t, t.prototype.getContents = function() {
            return [this.content]
        }, t
    })), a.d("FrontendComponentContent", ["FrontendComponentCommon"], (function() {
        function t(t, i, s) {
            this.content = s.querySelector(".n2-ss-section-main-content"), a.FrontendComponentCommon.prototype.constructor.call(this, t, i, s, this.content.querySelectorAll(":scope > .n2-ss-layer"))
        }
        return t.prototype = Object.create(a.FrontendComponentCommon.prototype), t.prototype.constructor = t, t.prototype.getContents = function() {
            return [this.content]
        }, t
    })), a.d("FrontendComponentLayer", ["FrontendComponentCommon"], (function() {
        function t(t, i, s) {
            a.FrontendComponentCommon.prototype.constructor.call(this, t, i, s);
            var n = s;
    ...
    })), a.d("FrontendComponentRow", ["FrontendComponentCommon"], (function() {
        function t(t, i, s) {
            this.row = s.querySelector(".n2-ss-layer-row"), this.rowInner = s.querySelector(".n2-ss-layer-row-inner"), a.FrontendComponentCommon.prototype.constructor.call(this, t, i, s, this.rowInner.querySelectorAll(":scope > .n2-ss-layer"))
        }
        return t.prototype = Object.create(a.FrontendComponentCommon.prototype), t.prototype.constructor = t, t.prototype.getContents = function() {
            return [this.row]
        }, t
    })), a.d("FrontendComponentSectionSlide", ["FrontendComponent"], (function() {
        function t(t, i, s) {
            this.realSlide = t, this.slider = i, this.element = t.element, this.layer = s, this.isStatic = t.isStatic(), a.FrontendComponent.prototype.constructor.call(this, this, this, s, s.querySelectorAll(":scope > .n2-ss-layer")), ut(i.sliderElement, "SliderDeviceOrientation", function(e) {
                this.onDeviceChange(e.detail.device.toLowerCase())
            }.bind(this)), ut(i.sliderElement, "SliderResize", function(e) {
                this.onResize(e.detail.ratios, e.detail.responsive.resizeContext)
            }.bind(this)), this.start()
        }
        return t.prototype = Object.create(a.FrontendComponent.prototype), t.prototype.constructor = t, t.prototype.onDeviceChange = function(t) {
            a.FrontendComponent.prototype.onDeviceChange.call(this, t);
            for (var i = 0; i < this.children.length; i++) this.children[i].onDeviceChange(t);
            this.realSlide.onDeviceChange(t)
        }, t
    })), a.d("SmartSliderResponsive", (function() {
        let t, c = !1;

        function f(t, s) {
            for (var n in this.state = {
                    StarterSlide: !1
                }, this.isVisible = !0, this.isResetActiveSlideEarly = this.isResetActiveSlideEarly || !1, this.focusOffsetTop = 0, this.focusOffsetBottom = 0, this.minimumSlideHeight = 0, this.ut = !1, this.visibleRealSlidesChanged = !0, this.wt = -1, this.yt = -1, this.gt = -1, this.kt = -1, this.filters = {
                    SliderWidth: [],
                    SliderHeight: [],
                    SlideHeight: [],
                    SliderVerticalCSS: []
            ...
            this.parameters.hideOn = i.ssOverrideHideOn || this.parameters.hideOn, this.doThrottledResize = NextendThrottle(this.doResize.bind(this), 50), this.slider = t, this.sliderElement = t.sliderElement, this.Ct = "1" === z(this.sliderElement, "ssLegacyFontScale"), this.addFilter("SliderWidth", this.filterSliderWidthHorizontalSpacing.bind(this))
        }
        return s.addEventListener("scroll", (function() {
            t && u(t), c = !0, t = r((function() {
                c = !1
            }), 300)
        }), {
            capture: !0,
            ...
            if (this.slider.stages.done("ResizeFirst", function() {
                ...
                }.bind(this)), this.normalizeTimeout = null, this.setDeviceID(f.DeviceMode.unknown), this.ratios = {
                    slideW: 1,
                    slideH: 1
                    ...
                    paddingBottom: 0,
                    paddingLeft: 0
                }, this.alignElement = this.slider.sliderElement.closest(".n2-ss-align"), this.m = this.slider.m, this.containerElementPadding = this.sliderElement.parentNode, this.containerElement = this.containerElementPadding.parentNode, !this.slider.isAdmin && this.parameters.overflowHiddenPage && B([n, h], "overflow", "hidden"), a._smallestZoom = 320, this.initFocusOffsetObserver(), this.slider.stages.resolve("ResponsiveStart"), this.init(), this.parameters.onResizeEnabled) {
                ut(i, "resize", this.onResize.bind(this)), this.lastROWidth = 0;
                var t = this.containerElement.parentNode,
                    s = new ResizeObserver(function(t) {
                        this.processResizeObserverRect(t[0].contentRect)
                    }.bind(this));
                requestAnimationFrame(function() {
                    this.processResizeObserverRect(t.getBoundingClientRect()), s.observe(t)
                }.bind(this))
            } else this.onResize()
            ...
            this.wt = i.innerWidth, this.yt = i.innerHeight, this.slider.mainAnimation && "playing" === this.slider.mainAnimation.getState() ? this.xt || (this.xt = !0, at(this.sliderElement, "mainAnimationComplete", this._onResize.bind(this, e))) : this._onResize(e)
        }, f.prototype._onResize = function(e) {
            this.doResize(e), delete this.xt
        }, f.prototype.doNormalizedResize = function() {
            this.normalizeTimeout && u(this.normalizeTimeout), this.normalizeTimeout = r(this.doResize.bind(this), 10)
            ...
            if ("" !== this.parameters.focus.offsetBottom) {
                var h;
                try {
                    h = s.querySelectorAll(this.parameters.focus.offsetBottom)
                } catch (t) {
            ...
            _(this.sliderElement, "--subtract-vertical-offset", (i.n2OffsetTop || this.focusOffsetTop) + (i.n2OffsetBottom || this.focusOffsetBottom) + "px"), this.doResize()
        }, f.prototype.doResize = function(e) {
            if (!this.slider.isAdmin && c && this.gt === this.wt) {
                const t = Math.abs(this.kt - this.yt);
                if (t > 0 && t < 100) return
            }
            this.gt = this.wt, this.kt = this.yt;
            var t = this.identifyDeviceID();
            if (this.parameters.hideOn[f._DeviceMode[t]]) return N(this.m, "n2-section-smartslider--hidden"), !1;
            if (G(this.m, "n2-section-smartslider--hidden"), !this.isVisible) return !1;
            var i = !1,
                s = this.device;
            if (this.deviceID !== t && (this.setDeviceID(t), s && G(this.sliderElement, "n2-ss-" + s), D(this.sliderElement, "deviceMode", this.device), N(this.sliderElement, "n2-ss-" + this.device), this.slider.u("SliderDevice", {
                    lastDevice: s,
                    device: this.device,
                    ...
                    device: this.device,
                    group: f._DeviceGroup[this.device]
                }), this.slider.stages.resolve("DeviceOrientation"), this.finalizeVisibleSlidesStage1()), !this.slider.visibleRealSlides.length) return this.parameters.hideOn[f._DeviceMode[t]] = !0, N(this.m, "n2-section-smartslider--hidden"), !1;
            if (this.slider.isVisible || this.visibleRealSlidesChanged) {
                for (var n = 0; n < this.slider.realSlides.length; n++) a.MW.i(this.slider.realSlides[n].element).setValues({
                    width: "",
                    height: ""
                }), V(this.slider.realSlides[n].element, {
                    width: "",
                    height: ""
                });
                this.resizeStage1Width(), this.slider.u("SliderResizeHorizontal"), this.resizeStage2Height()
            }
            ...
            }, this.Ct && B(this.sliderElement.querySelectorAll('.n2-ss-layer[data-sstype="slide"] > .n2-ss-layer[data-pm="absolute"][data-adaptivefont="0"]'), "font-size", "calc(" + 16 * this.ratios.slideW + "px * var(--ssfont-scale, 1))");
            for (var t = 0; t < this.slider.realSlides.length; t++) a.MW.i(this.slider.realSlides[t].element).setValues({
            ...
            })), this.updateVisibleSlides(), this.slider.u("visibleRealSlidesChanged"), this.slider.stages.resolve("VisibleRealSlides"), this.isResetActiveSlideEarly && this.calibrateActiveSlide())
            ...
            var i, s;
            t && t !== this.slider.currentRealSlide ? (this.slider.u("BeforeCurrentSlideChange", t), (i = this.slider.currentSlide) && this.slider.forceUnsetActiveSlide(i), this.slider.setCurrentRealSlide(t), s = this.slider.currentSlide, this.targetCurrentSlide = s, this.slider.forceSetActiveSlide(s), this.slider.u("SlideForceChange", {
                oldSlide: i,
                currentSlide: s
            })) : s = this.slider.currentSlide, this.slider.updateInsideSlides([s])
        }, f.prototype.finalizeVisibleSlidesStage2 = function() {
            this.visibleRealSlidesChanged && (this.visibleRealSlidesChanged = !1, this.isResetActiveSlideEarly || this.calibrateActiveSlide(), this.triggerVisibleSlidesChanged(), this.targetCurrentSlide !== o && (this.slider.u("SlideWillChange", {
                targetSlide: this.targetCurrentSlide
            }), this.slider.u("CurrentSlideChanged", {
            ...
            this.slider.u("visibleSlidesChanged"), this.slider.stages.resolve("VisibleSlides"), this.slider.visibleRealSlides.length ? this.slider.isVisible || this.slider.show() : this.slider.isVisible && this.slider.hide()
            ...
            return this.ut ? 0 : this.slider.widgets.getVerticalsHeight()
            ...
            return V(this.containerElementPadding, {
    ...
    })), a.d("FrontendItemVimeo", (function() {
        function t(t, i, n, h, o, r) {
            if (this.state = {
                    ...
                    this._resolve = t
                }.bind(this)), this.slider = t, this.playerId = i, this.playerElement = s.getElementById(this.playerId), this.cover = this.playerElement.querySelector(".n2_ss_video_player__cover"), this.hasImage = o, this.start = r, this.parameters = g({
            ...
            n2const.isLighthouse || a.r("windowLoad", this.whenLoaded.bind(this))
        }
        var i;
        return t.prototype.whenLoaded = function() {
            1 === parseInt(this.parameters.autoplay) || !this.hasImage || n2const.isMobile ? this.ready(this.initVimeoPlayer.bind(this)) : this.ready(function() {
                var t = function(e) {
                        ot(i), e.preventDefault(), e.stopPropagation(), this.initVimeoPlayer(), this.safePlay()
                    }.bind(this),
                    i = [rt(this.playerElement, "click", t), rt(this.playerElement, "n2click", t)]
            }.bind(this))
        }, t.prototype.ready = function(t) {
            ...
            var t = f("iframe");
            t.className = "intrinsic-ignore", t.allow = "fullscreen; autoplay; encrypted-media", t.id = this.playerId + "-frame", t.src = "https://player.vimeo.com/video/" + this.parameters.vimeocode + "?autoplay=0&_video&title=" + this.parameters.title + "&byline=" + this.parameters.byline + "&background=" + this.parameters.background + "&portrait=" + this.parameters.portrait + "&color=" + this.parameters.color + "&loop=" + this.parameters.loop + ("-1" == this.parameters.quality ? "" : "&quality=" + this.parameters.quality) + "&dnt=" + this.parameters["privacy-enhanced"] + ("" !== this.parameters.privateid ? "&h=" + this.parameters.privateid : ""), t.webkitAllowFullScreen = !0, t.allowFullScreen = !0, V(t, {
                position: "absolute",
                top: 0,
                left: 0,
                width: "100%",
            ...
            this.layer = i.layer, new ResizeObserver(function(t) {
            ...
            }.bind(this)).observe(this.layer.layer), this.slide.isVisible && this.setState("slideVisible", !0, !0), ut(this.slide.element, "Hidden", function() {
                var t = this.state.play;
                this.setState("slideVisible", !1, !0), t && this.setState("continuePlay", !0)
            }.bind(this)), ut(this.slide.element, "Visible", function() {
                this.setState("slideVisible", !0, !0)
            }.bind(this)), this.cover && (n2const.isMobile && at(this.cover, "click", this.safePlay.bind(this)), at(i, "n2play", function() {
                a.J.to(a.MW.i(this.cover), .3, {
                    opacity: 0,
                    onComplete: function() {
                        Y(this.cover)
                    }.bind(this)
                ...
                this.isStatic || ht(this.slider.sliderElement, "mediaStarted", {
                    id: this.playerId
                }), nt(i, "n2play")
            }.bind(this)), this.player.on("pause", function() {
                nt(i, "n2pause"), this.state.continuePlay ? (this.setState("continuePlay", !1), this.setState("play", !0)) : this.setState("play", !1)
            }.bind(this)), this.player.on("ended", function() {
                this.isStatic || ht(this.slider.sliderElement, "mediaEnded", {
                    id: this.playerId
                }), nt(i, "n2stop"), this.setState("play", !1), "next" === this.parameters.ended && 0 == this.parameters.loop && ((s.fullscreenElement || s.webkitFullscreenElement) && (s.exitFullscreen || s.webkitExitFullscreen).call(s), this.slider.next(!0))
            }.bind(this)), this.isStatic || (ut(this.slider.sliderElement, "CurrentSlideChanged", function(e) {
                this.onCurrentSlideChange(e.detail.currentSlide)
            }.bind(this)), ut(this.slider.sliderElement, "mainAnimationStart", function(e) {
                this.onCurrentSlideChange(this.slider.slides[e.detail.currentSlideIndex])
            }.bind(this))), "" !== this.parameters["scroll-pause"] ? a.ScrollTracker.add(this.playerElement, this.parameters["scroll-pause"], function() {
            ...
            this.setState("InComplete", !0, !0), this.isStatic ? (this.setState("play", !0), this.setState("slide", !0, !0)) : (ut(this.slider.sliderElement, "mainAnimationComplete", function(e) {
            ...
            s = s || !1, this.state[t] = i, s && (this.state.slideVisible && this.state.visible && this.state.play && this.state.slide && this.state.InComplete && this.state.scroll && this.layer.isVisible ? this.play() : this.pause(), this.state.slideVisible && this.state.visible && this.state.slide && this.layer.isVisible ? P(this.player.element, "tabindex") : x(this.player.element, "tabindex", "-1"))
        }, t.prototype.play = function() {
            ht(this.slider.sliderElement, "mediaStarted", {
                id: this.playerId
    ...
    })), a.d("FrontendItemYouTube", (function() {
        function t(t, i, n, h) {
            this.state = {
                slideVisible: !1,
                visible: !1,
                ...
                this._resolve = t
            }.bind(this)), this.slider = t, this.playerId = i, this.playerElement = s.getElementById(this.playerId), this.cover = this.playerElement.querySelector(".n2_ss_video_player__cover"), this.hasImage = h, this.parameters = g({
                ...
                query: [],
                playsinline: 0
            }, n), n2const.isLighthouse || a.r("windowLoad", this.whenLoaded.bind(this))
        }
        var n;
        return t.prototype.whenLoaded = function() {
            if (1 === parseInt(this.parameters.autoplay) || !this.hasImage || n2const.isMobile) this.ready(this.initYoutubePlayer.bind(this));
                    ...
                    ot(i), e.preventDefault(), e.stopPropagation(), this.ready(function() {
            ...
            this.coverFadedOut === o && this.cover && (this.coverFadedOut = !0, a.J.to(a.MW.i(this.cover), .3, {
                opacity: 0,
                onComplete: function() {
                    Y(this.cover)
                }.bind(this)
            ...
            this.layer = t.layer, this.cover && (n2const.isMobile && at(this.cover, "click", this.play.bind(this)), at(t, "n2play", this.fadeOutCover.bind(this))), this.slide = this.slider.findSlideByElement(this.playerElement), this.isStatic = this.slide.isStatic();
            var n = {
                enablejsapi: 1,
                    ...
                    onStateChange: function(i) {
                        switch (i.data) {
                            ...
                            case YT.PlayerState.BUFFERING:
                                this.isStatic || this.slide.isActiveWhen(this.slider.currentSlide) && ht(this.slider.sliderElement, "mediaStarted", {
                                    id: this.playerId
                                }), nt(t, "n2play");
                                break;
                            case YT.PlayerState.PAUSED:
                                nt(t, "n2pause"), this.state.continuePlay ? (this.setState("continuePlay", !1), this.setState("play", !0)) : this.setState("play", !1);
                                break;
                            case YT.PlayerState.ENDED:
                                1 == this.parameters.loop ? (this.player.seekTo(this.parameters.start), this.player.playVideo()) : (this.isStatic || ht(this.slider.sliderElement, "mediaEnded", {
                                    id: this.playerId
                                }), nt(t, "n2stop"), this.setState("play", !1), "next" === this.parameters.ended && ((s.fullscreenElement || s.webkitFullscreenElement) && (s.exitFullscreen || s.webkitExitFullscreen).call(s), this.slider.next(!0)))
                        }
                    }.bind(this)
                }
            };
            (this.parameters["privacy-enhanced"] || i.jQuery && i.jQuery.fn.revolution) && (o.host = "https://www.youtube-nocookie.com"), this.player = new YT.Player(this.playerId + "-frame", o), 1 == this.parameters.center && (_(this.playerElement.parentNode, "overflow", "hidden"), this.onResize(), ut(this.slider.sliderElement, "SliderResize", this.onResize.bind(this)))
        }, t.prototype.onReady = function() {
            ...
            t > 0 ? this.setVolume(t) : -1 !== t && this.player.mute(), new ResizeObserver(function(t) {
                ...
                this.setState("slideVisible", !0, !0)
            }.bind(this)), this.slide.isActiveWhen() && this.setState("slide", !0, !0), 1 == this.parameters.autoplay && this.slider.visible(this.initAutoplay.bind(this)), this.isStatic || (ut(this.slider.sliderElement, "CurrentSlideChanged", function(e) {
                this.onCurrentSlideChange(e.detail.currentSlide)
            }.bind(this)), ut(this.slider.sliderElement, "mainAnimationStart", function(e) {
                this.onCurrentSlideChange(this.slider.slides[e.detail.currentSlideIndex])
            }.bind(this)), parseInt(this.parameters.reset) && ut(this.slider.sliderElement, "mainAnimationComplete", function(e) {
            ...
            }.bind(this))), this._resolve(), "" !== this.parameters["scroll-pause"] ? a.ScrollTracker.add(this.playerElement, this.parameters["scroll-pause"], function() {
                this.setState("scroll", !0, !0)
            }.bind(this), function() {
                this.setState("continuePlay", !0), this.setState("scroll", !1, !0)
            ...
            h[n2const.rtl["margin-left"]] = 0, i / s > n ? (h.height = i * n + "px", h["margin-top"] = (s - i * n) / 2 + "px") : (h.width = s * n + "px", h[n2const.rtl["margin-left"]] = (i - s * n) / 2 + "px"), V(this.playerElement, h)
        }, t.prototype.initAutoplay = function() {
            this.setState("InComplete", !0, !0), this.isStatic ? (this.setState("play", !0), this.setState("slide", !0, !0)) : (ut(this.slider.sliderElement, "mainAnimationComplete", function(e) {
                this.slide.isActiveWhen(this.slider.slides[e.detail.currentSlideIndex]) ? (this.setState("play", !0), this.setState("slide", !0, !0)) : this.setState("slide", !1, !0)
            }.bind(this)), this.slide.isActiveWhen() && (this.setState("play", !0), this.setState("slide", !0, !0)))
            ...
            this.isStopped() && (this.coverFadedOut === o && r(this.fadeOutCover.bind(this), 200), ht(this.slider.sliderElement, "mediaStarted", {
                id: this.playerId
